 ...
 *
 */
@Component(service = ContactReplication.class, immediate = true)
public final class ContactReplication {
  ...
  private static final String INFORMATION = "contactinfo";
  private static final String UNIQUE_ID = "unq_id";
  private static final String BUCKET = "BUCKET";
  private static final String PERSONID = "PERSONID";
  private static final String LASTNAME = "LASTNAME";
  private static final String FIRSTNAME = "FIRSTNAME";
  private static final String LASTNAME_STRIP = "LASTNAME_STRIP";
  private static final String FIRSTNAME_STRIP = "FIRSTNAME_STRIP";
  private static final String RESOURCE_TYPE = "sling:resourceType";
  private static final String RESOURCE_TYPE_VALUE = "gnb/components/page/gnbpage";
