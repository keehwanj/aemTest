...
public class NewExternal {
   ...
   * internal logger
   */
  private static final Logger log = LoggerFactory.getLogger(NewExternal.class);
   ...
   */
  public NewExternal(Resource resource, Page page, String spoolSelector, String postSelector, String targetParam) {
  ...
  public void draw(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    Rewriter rewriter = new Rewriter(pagePath, resourcePath, target, postSelector, targetParam);
