...
public final class OrganizationReplication {
  ...
  final private static String UNIQUE_ID_TYPE = "unq_id";

  final private static String SLING_RESOURCE_TYPE = "sling:resourceType";
  final private static String SLING_RESOURCE_TYPE_VALUE = "gnb/components/page/gnbpage";
  final private static String ORGANIZATION_PATH = "ORGANIZATION_PATH";
  final private static String CONTACT_INFO = "contactinfo";
  final private static String GROUPS_TYPE = "GROUPS";
  final private Map<String, List<String>> groupMap = new HashMap<String, List<String>>();
  ...
  final static String ORG_GROUP_SQL = "select orgid, groupid from contactgroupentries order by 1";

  final String ORG_SVC_SQL = "select od.ORGID, st.SERVICESID "
      + "from organizationdept od join servicestable st on od.DEPTID = st.DEPTID "
      + "and st.servicetypeid in (2,3) and st.statusid = 'A' " + "UNION " + "select sc.orgid, st.servicesid "
      + "from servicescontacts sc join servicestable st on sc.servicesid = st.servicesid "
      + "and st.servicetypeid in (2,3) and st.statusid = 'A' " + "order by 1" + "";

  final static String ORG_SQL = "select " + "o.DEPTID, o.ORGID, o.ORGLEVEL, o.ORGTYPE, o.ORGNAMEENG, o.ORGNAMEFRE, "
      ...
      + "pat.ADDRESSFRE3 as P_ADDRESSFRE3, pat.CITYFRE as P_CITYFRE, " + "pat.PROVINCEFRE as P_PROVINCEFRE, "
      ...
      + "mat.ADDRESSFRE3 as M_ADDRESSFRE3, mat.CITYFRE as M_CITYFRE, " + "mat.PROVINCEFRE as M_PROVINCEFRE, "
      + "o.GOALENG, o.GOALFRE, o.RECPHONE, " + "o.RECAREACODE, o.RECPHONESCHEDULEENG, o.RECPHONESCHEDULEFRE, o.FAX, "
      ...
      + "mat.ADDRESSFRE2, mat.ADDRESSFRE3, mat.CITYFRE, mat.PROVINCEFRE, " + "o.GOALENG, o.GOALFRE, o.RECPHONE, "
  ...
  public void replicate(DataSource dataSource, Node dataNode, Session session, QueryBuilder queryBuilder)
    ...
    try {
      ...
      if(newUniqueId!=null)
        cleanUpOldOrganizations(orgDataNode, session, queryBuilder, newUniqueId);
  ...
  //log.error("Created org info node :  Org = " + orgId + " deptid = " + deptId + " newuniqueid= " + newUniqueId ) ; 
            ...
            if (previousNode == null) {
                ...
                String previousLevel = previousNode.getNode(Fields.ORG_INFORMATION.text()).getProperty(
                Fields.ORGANIZATION_LEVEL.text()).getString();
  ...
  private void syncOrganizationsWithServices(Connection conn, Node orgDataNode) throws RepositoryException,
      SQLException {
    ...
    try {
      ...
      if (orgNode != null) {
        orgNode.getNode(Fields.ORG_INFORMATION.text()).setProperty(Fields.SERVICES_PROP.text(),
            svcs.toArray(new String[0]));
      }
      orgDataNode.save();
   ...
   **/
  private void createOrganizationInfoNode(Node rootNode, int deptId, String orgLevel, String newUniqueId, ResultSet rs, Map<String, List<String>> groupMap)
      throws RepositoryException, SQLException {
