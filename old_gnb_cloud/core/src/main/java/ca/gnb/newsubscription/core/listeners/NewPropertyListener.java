...
//				}
				...
				if (status_activation.equals("ACTIVATED")
			...
			log.error("error in ResourceResolver resourceResolver", e);
			e.printStackTrace();
	...
	private void emailPAGE(String webPathDomain, ResourceResolver resourceResolver, String nodePath, Event event)
			throws EmailException, ValueFormatException, IllegalStateException, PathNotFoundException,
			RepositoryException {
		/// START
		...
		if (res != null) {
			...
			if ((node.hasProperty("subscription")) && (node.hasProperty("subscriptionID"))
					&& (node.hasProperty("cq:tags"))) {
	...
	private void emailDAM(String webPathDomain, ResourceResolver resourceResolver, String nodePath, Event event)
			throws ValueFormatException, IllegalStateException, PathNotFoundException, RepositoryException,
			EmailException {
	...
	private void sendingEmail(ResourceResolver resourceResolver, Value[] values, Event event, String web_path,
			String title, String subscription, String subscriptionID) throws EmailException, RepositoryException {
