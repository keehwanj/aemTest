...
function adCalc(form) {
    ...
    var FTInfants_1 = FTInfants;
    var PTInfants_1 = PTInfants;
    var FTChild_1 = FTChild;
    var PTChild_1 = PTChild;    

    var FTIdays_1 = FTIdays/4.2;
    var PTIdays_1 = PTIdays/4.2;
    var FTCdays_1 = FTCdays/4.2;
    var PTCdays_1 = PTCdays/4.2;
    ...
    if (income > 0 && income < 22001) {
        ...
        monthly = ((FTInfants_1 * FTIdays_1) + (PTInfants_1 * PTIdays_1) + (FTChild_1 * FTCdays_1) + (PTChild_1 * PTCdays_1))*4.2*totalfamily;
        $("#monthly").val(monthly.toFixed(2));
        //form.yearly.value = (monthly * 12).toFixed(2);
        ok++;
    }
    if (income >= 22001 && income < 23001) {
        totalfamily = (FTInfants = FTInfants * 28.50) + (PTInfants = PTInfants * 14.50) + (FTChild = FTChild * 24.25) + (PTChild = PTChild * 12.75);
        form.family.value = totalfamily.toFixed(2);
        monthly = ((FTInfants_1 * FTIdays_1) + (PTInfants_1 * PTIdays_1) + (FTChild_1 * FTCdays_1) + (PTChild_1 * PTCdays_1))*4.2*totalfamily;
        $("#monthly").val(monthly.toFixed(2));
