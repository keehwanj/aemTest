 ...
 * v4.0.26-development - 2017-07-17
 *
 */
...
!function(a) {
    ...
    a.i18nDict= {
        ...
        process:"traitement...",
        srch:"Recherche",
        "no-match":"Aucune correspondance trouvÃ©e",
        matches: {
            mixin: "[MIXIN] correspondance(s) trouvÃ©es"
        }
        ,
        current:"(actuel)",
        hide:"Masquer",
        ...
        prv:"PrÃ©cÃ©dent",
        "prv-l":"PrÃ©cÃ©dent (touche gauche)",
        first:"Premier",
        last:"Dernier",
        page:"Page",
        ...
        "overlay-close":"Fermer la fenÃªtre superposÃ©e",
        "esc-key":"(touche d'Ã©chappement)",
        show:"Afficher",
        "tab-rot": {
            off: "ArrÃªter la rotation d'onglets", on: "Lancer la rotation d'onglets"
        }
        ,
        "tab-list":"Liste des onglets",
        "tab-pnl-end1":"Fin de ce panneau Ã  onglets.",
        "tab-pnl-end2":"Retourner Ã  la liste des onglets",
        ...
        volume:"Volume",
        mute: {
            on: "Activer le mode muet", off: "DÃ©sactiver le mode muet"
        }
        ,
        cc: {
            off: "Masquer le sous-titrage", on: "Afficher le sous-titrage"
        }
        ,
        "cc-err":"Erreur dans le chargement des sous-titres",
        adesc: {
            on: "Activer l'audiodescription", off: "DÃ©sactiver l'audiodescription"
        }
        ,
        ...
        "shr-txt":"Partagez",
        "shr-pg":" cette page",
        "shr-vid":" cette vidÃ©o",
        "shr-aud":" ce fichier audio",
        "shr-hnt":" avec {s} ",
        "shr-disc":"Aucun appui nâ€™est accordÃ©, soit de faÃ§on expresse ou tacite, Ã  aucun produit ou service.",
        "frm-nosubmit":"Le formulaire n'a pu Ãªtre soumis car ",
        "errs-fnd":" erreurs ont Ã©tÃ© trouvÃ©es.",
        "err-fnd":" erreur a Ã©tÃ© trouvÃ©e.",
        "date-hide":"Masquer le calendrier",
        "date-show":"SÃ©lectionner une date Ã  partir d'un calendrier pour le champ:",
        "date-sel":"SÃ©lectionnÃ©",
        days:["Dimanche",
        "Lundi",
        "Mardi",
        "Mercredi",
        ...
        "cal-goToLnk":'Aller au<span class="wb-inv"> mois de l\'annÃ©e</span>',
        "cal-goToTtl":"Aller au mois de l'annÃ©e",
        "cal-goToMnth":"Mois :",
        "cal-goToYr":"AnnÃ©e :",
        "cal-goToBtn":"Aller",
        prvMnth:"Mois prÃ©cÃ©dent : ",
        nxtMnth:"Mois suivant : ",
        "lb-curr":"Article %curr% de %total%",
        "lb-xhr-err":"Le chargement de ce contenu a Ã©chouÃ©.",
        "lb-img-err":"Le chargement de cette image a Ã©chouÃ©.",
        "tbl-txt":"Tableau",
        "tbl-dtls":"Graphique. Plus de dÃ©tails dans le tableau suivant.",
        "st-to-msg-bgn":"Votre session expirera automatiquement dans #min# min #sec# sec.",
        "st-to-msg-end":"SÃ©lectionner Â« Continuer la session Â» pour prolonger votre session.",
        "st-msgbx-ttl":"Avertissement d'expiration de la session",
        "st-alrdy-to-msg":"DÃ©solÃ©, votre session a dÃ©jÃ  expirÃ©. S'il vous plaÃ®t ouvrir une nouvelle session.",
        "st-btn-cont":"Continuer la session",
        "st-btn-end":"Mettre fin Ã  la session",
        "td-toggle":"Basculer tout",
        "td-open":"Afficher tout",
        "td-close":"RÃ©duire tout",
        "td-ttl-open":"Afficher toutes les sections de contenu",
        "td-ttl-close":"RÃ©duire toutes les sections de contenu",
        sortAsc:"&#160;: activer pour tri ascendant",
        sortDesc:"&#160;: activer pour tri descendant",
        emptyTbl:"Aucune donnÃ©e n'est disponible dans le tableau",
        infoEntr:"Affiche _START_ Ã  _END_ de _TOTAL_ entrÃ©es",
        infoEmpty:"Affiche 0 Ã  0 de 0 entrÃ©es",
        infoFilt:"(filtrÃ© de _MAX_ entrÃ©es totales)",
        info1000:"&#160;",
        lenMenu:"Afficher _MENU_ entrÃ©es",
        filter:"Filtrer les articles",
        "geo-mapctrl":"@geo-mapctrl@",
        "geo-zmin":"Zoom avant",
        "geo-zmout":"Zoom arriÃ¨re",
        "geo-zmwrld":"Zoom sur l'Ã©tendue de la carte",
        "geo-zmfeat":"Zoom Ã  l'Ã©lÃ©ment",
        "geo-sclln":"Ã‰chelle de la carte",
        "geo-msepos":"Latitude et longitude du curseur de la souris",
        "geo-ariamap":"Objet de la carte. Les descriptions des caractÃ©ristiques de la carte se trouvent dans la table ci-dessous.",
        "geo-ally":"<strong>Utilisateurs de clavier :</strong> Lorsque la carte a l'attention, utiliser les touches flÃ¨ches pour dÃ©placer la carte et utiliser les touches plus et nÃ©gatif pour faire un zoom. La carte ne peut Ãªtre dÃ©placÃ©e lorsque le zoom est Ã  son Ã©tendue maximal.",
        "geo-allyttl":"Instructions : comment naviguer dans la carte",
        "geo-tgllyr":"Basculer l'affichage de la couche",
        "geo-hdnlyr":"Cette couche est prÃ©sentement cachÃ©e.",
        ...
        "geo-attrttl":"GÃ©oGratis - Carte de base du Canada",
        "geo-sel":"SÃ©lectionnez",
        "geo-lblsel":"Cochez pour sÃ©lectionner cet Ã©lÃ©ment sur la carte",
        ...
        "geo-aoi-south":"Sud",
        "geo-aoi-west":"Ouest",
        "geo-aoi-instructions":"DÃ©limiter un territoire sur la carte ou entrer les coordonnÃ©es ci-dessous, puis cliquer sur le bouton &#171;&#160;Ajouter&#160;&#187;.",
        "geo-aoi-btndraw":"Tracer",
        "geo-aoi-btnclear":"Enlever",
        "geo-geoloc-btn":"Zoom sur votre position actuelle",
        "geo-geoloc-fail":"Localisation a Ã©chouÃ©. S'il vous plaÃ®t s'assurer que les services de localisation sont activÃ©s.",
        "geo-geoloc-uncapable":"Localisation n'est pas supportÃ© par votre navigateur.",
        "geo-lgnd-grphc":"Graphique lÃ©gende couche cartographique.",
        "wb-disable":"Passer au version HTML simplifiÃ©e",
        "wb-enable":"Passer au version standard",
        "disable-notice-h":"Avis: Version HTML simplifiÃ©e",
        "disable-notice":"Vous naviguez prÃ©sentement sur la version HTML simplifiÃ©e de cette page. Certaine fonctionalitÃ©s peuvent Ãªtre dÃ©activÃ©es.",
        dismiss:"Ã‰carter",
