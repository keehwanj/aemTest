...
<!--
<cq:includeClientLib css="ag.components.tabpanel"/>
<cq:includeClientLib js="ag.components.tabpanel"/>
-->
<!--
<script type="text/javascript"
	src="/apps/agnb-vgnb/components/content/tabpanel/jquery-bbq-plugin.js"></script>
-->
