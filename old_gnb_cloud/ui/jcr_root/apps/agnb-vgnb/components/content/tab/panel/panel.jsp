...
<div class="config" style="padding:2px; margin-bottom:2px; border: 1px solid #ddd;border-top-width: 0;"
    ...
    <span>&nbsp;</span>
    <%--<cq:include path="start" resourceType="agnb-vgnb/components/content/tab/panel/start"/>--%>
    <cq:include path="tab-panel-components" resourceType="agnb-vgnb/components/content/tab/panel/parsys"/>
    <%--<cq:include path="end" resourceType="agnb-vgnb/components/content/tab/panel/end"/>--%>
    <span>&nbsp;</span>
</div>
