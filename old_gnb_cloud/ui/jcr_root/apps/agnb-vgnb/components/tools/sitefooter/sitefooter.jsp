...
<%
    ...
    try {
        ...
        //sUrl = "https://agnb-vgnb.ca" + sUrl + selectors + ".html"; 
	...
	<div class="col-lg-5 col-md-5  col-xs-12">
		<div id="siteFooterNav" class="right">
			<ul>
    			...
    			<li><a href="<%=getLocalization("privacyPath", "/content/agnb-vgnb/en/privacy.html", currentPage, log)%>.html"><%=getLocalization("privacyText", "Privacy", currentPage, log)%></a></li>
    			<li><a href="<%=getLocalization("disclaimerPath", "/content/agnb-vgnb/en/disclaimer.html", currentPage, log)%>.html"><%=getLocalization("disclaimerText", "Disclaimer", currentPage, log)%></a></li>
			</ul>
		</div>
  	</div>
</div>   
