...
<ul>
    ...
    <%if (lang.equals("en")) {%>
    	<li class="visible-sm visible-md"><a href="//www.agnb-vgnb.ca/content/agnb-vgnb/en/search.html">Search</a></li>   
    	<li class="visible-xs visible-sm visible-md"><a href="//www.agnb-vgnb.ca/content/agnb-vgnb/en/media.html">Media</a></li>      

    <%}
	else{%>
    	<li class="visible-sm visible-md"><a href="//www.agnb-vgnb.ca/content/agnb-vgnb/fr/recherche.html">Recherche</a></li>   
    	<li class="visible-xs visible-sm visible-md"><a href="//www.agnb-vgnb.ca/content/agnb-vgnb/fr/media.html">M&eacute;dia</a></li>      

    <%}%>
    <!--END of about us/media/search-->    

    <!--START of languageSwitcher-->    
    <li><cq:include path="languageSwitcher" resourceType="agnb-vgnb/components/tools/languageswitcher" /></li>
