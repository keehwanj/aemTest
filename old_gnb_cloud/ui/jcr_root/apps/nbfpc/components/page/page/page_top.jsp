    ...
    if (WCMMode.fromRequest(request) == WCMMode.EDIT) {
      Locale locale = currentPage.getLanguage(true);
        ...
        if(locale !=null) {
            ...
            String en_text="Forest Products Commission";
            String fr_text="Commission des produits forestiers";
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("en")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Commission des produits forestiers");    
                }
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("fr")) {
                ...
                if(gnbPublisher_text.equals(en_text)){
                    currentNode.setProperty("gnbPublisher","Forest Products Commission");    
                }
            }
