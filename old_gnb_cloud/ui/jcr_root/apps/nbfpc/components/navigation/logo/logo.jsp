...
<%
  ...
  String rendition_640="/jcr:content/renditions/cq5dam.web.600.400.png";
...
<picture>
    ...
    <source srcset="<%=backgroundLogo%><%=rendition_640%>" media="(min-width: 980px)">
    <source srcset="<%=backgroundLogo%><%=rendition_640%>" media="(min-width: 768px)">
    <source srcset="<%=backgroundLogo%><%=rendition_640%>" media="(min-width: 480px)">
    <source srcset="<%=backgroundLogo%><%=rendition_640%>" media="(min-width: 400px)">   
    <source srcset="<%=backgroundLogo%><%=rendition_640%>" media="(min-width: 200px)">       
    <!--[if IE 9]></video><![endif]-->
