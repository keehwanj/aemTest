...
//String brand = properties.get("brand", "Government of New Brunswick");
	String[] brand = new String[2];
  	...
  	brand = getStringPropertyValue(currentPage.adaptTo(Node.class), "nbfpc_mainNav_ipar", "mainnav", "brand", log);
...
window.addEventListener('load', function(event){
  // do stuff here
    ...
    // do something for small screens
        ...
        var width = Math.floor(100 / $("ul#mainnav.nav.navbar-nav li").size());
        $("ul#mainnav.nav.navbar-nav li").css('width', "100%"); 
	}
    ...
    // do something for big screens
        ...
        var width = Math.floor(100 / $("ul#mainnav.nav.navbar-nav li").size());
        $("ul#mainnav.nav.navbar-nav li").css('width', width + "%");   
	}
	else  {
