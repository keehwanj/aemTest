...
<header>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		if (backgroundLogo != null) {
			...
			%>
				<a class="navbar-brand" href="<%=link%>">
                    <img src="<%=backgroundLogo%>"  class="d-inline-block align-top img-responsive mr-3" alt="<%=linkText%>">
        		</a>
        	<%
    		}
		}
    	...
    	<div class="collapse navbar-collapse" id="navbarSupportedContent">
                	...
                	for(int i=0;i<headerLeng;i++){ %>
                		<%if(i==0){%>
							<li class="nav-item active">
                    			<a class="nav-link" href="<%=headerLinksArray[i]%>.html"><%=headerLinkTextArray[i]%><span class="sr-only">(current)</span></a>
      						</li>
                		<%} else{%>
							<li class="nav-item">
        	...
        	<!--start search form-->
            <!--to do : action/placeholder text/adding hidden-->
        	<form class="form-inline my-3 pr-4 ml-lg-0">
            	<input class="form-control-sm m-1" type="search" placeholder="Search">
        	...
        	<!--start language-->
        	<a href="<%=oppositeUrl%>" class="btn btn-light my-3 pr-4 ml-lg-0" role="button"><%=oppositeUrl%></a>
        	<!--end language-->
