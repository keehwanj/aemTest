 		...
 		<div id="main_content_wrapper">
    		...
    		<div class="row">
                <div class="col-sm-2 col-md-2 col-lg-2  home_upper_left">
                    <cq:include path="home_upper_left_snb" resourceType="foundation/components/parsys"/>
    			</div>
				...
				<div class="col-sm-3 col-md-3 col-lg-3 home_upper_right">
                    <cq:include path="home_upper_right_snb" resourceType="foundation/components/parsys"/>
    			</div>
			</div><!--row-->     
  			<div class="row">
    			<div class="col-sm-6 col-md-6 col-lg-5 home_bottom_left">
                    <cq:include path="home_text_left_snb" resourceType="foundation/components/parsys"/>
    			</div>
    			<div class="col-sm-6 col-md-6 col-lg-7 home_bottom_right">
                    <cq:include path="home_text_right_snb" resourceType="foundation/components/parsys"/>
    			</div>
  			</div>
  			<div class="row">
    			<div class="col-sm-12 home_bottom">
                    <cq:include path="home_text_bottom_snb" resourceType="foundation/components/parsys"/>
    			</div>
  			</div>            
