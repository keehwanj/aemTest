...
<div class="addthis_toolbox addthis_default_style">
    ...
    <a class="addthis_button" href="https://www.addthis.com/bookmark.php?v=250&amp;username=commnb">
        ...
        <img alt ="<%=resources.get("share")%>1" src="https://s7.addthis.com/static/btn/v2/lg-share-<%=lang%>.gif" width="125" height="16" style="border:0"/>
    </a>    
