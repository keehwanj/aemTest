...
String renderer_page = "http://www2.snb.ca/content/snb/fr/services/services_renderer.";
//out.write ("got here<br><br>") ; 

if (locale == null || locale.getLanguage().equalsIgnoreCase("en")) {
    //out.write ("local = " + locale.getLanguage() + "<br><br>" ) ; 
    //out.write ("in here<br><br>")  ; 
    lang = "en";
	langSuffix = "";    
	language="English";
    renderer_page = "//www2.snb.ca/content/snb/en/services/services_renderer.";
}
//======End
%>
<%
...
//if(renderer_page==""){
    //renderer_page = "http://www2.gnb.ca/content/gnb/en/contacts/dept_renderer";
    //renderer_page = "http://www2.gnb.ca/content/gnb/en/services/services_renderer.";
	//renderer_page = "http://www2.gnb.ca/content/gnb/en/services/services_renderer";
//}
...
if(unique_id.equalsIgnoreCase("")){
	unique_id="online_services2";
} 
//String show_entries="10";

//setting resource tab for English/French
String title_h = properties.get("contact_information_h", "");
