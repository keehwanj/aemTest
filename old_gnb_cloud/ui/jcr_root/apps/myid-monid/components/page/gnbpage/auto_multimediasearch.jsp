...
*/
String serviceDataPage = "/content/dam/gnb/multimedia";
...
map.put("1_property", "dc:format");
map.put("1_property.value", "image/jpeg");
map.put("2_property", "dam:title_"+lang_s);
...
for (int i=0; i<list.size(); i++) {
    ...
    //Node serviceDataNode = node.getNode("jcr:content/metadata");
	String title = ""; 
    title = node.getProperty("dam:title_"+lang_s).getString().trim().toLowerCase();
    //title = node.getProperty("dam:title_"+lang_s).getString().trim();
    //title = list.getProperty("dam:title_"+lang_s).getString().trim();
