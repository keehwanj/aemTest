      ...
      <div id="main_content_wrapper">
         ...
         <div class="row">
            ...
            <div class="col-sm-4">
               ...
               <div id="sidebar2">
                  <div id="pageToolbar">
                     <cq:include path="pageToolbar_myid" resourceType="myid/components/tools/pagetools"/>
                  </div>
                  <cq:include path="tNav_ipar_myid" resourceType="foundation/components/iparsys"/>
                  <cq:include path="tCon_par_myid" resourceType="foundation/components/parsys"/>
               </div>
               <!--END  of id=sidebar-->
            </div>
