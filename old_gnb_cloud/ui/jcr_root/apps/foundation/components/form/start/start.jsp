...
%><cq:setContentBundle/>
<!--START of form css including manually-->

<!--END of form css including manually-->
...
%>
<!--START adding html class for responsive design-->
<script>
$(document).ready(function(){
	$("form").addClass("form-horizontal");
});
</script>
<!--END adding html class for responsive design-->