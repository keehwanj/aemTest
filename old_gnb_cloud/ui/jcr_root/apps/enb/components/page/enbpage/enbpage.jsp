    ...
    if (WCMMode.fromRequest(request) == WCMMode.EDIT) {
      Locale locale = currentPage.getLanguage(true);
        ...
        if(locale !=null) {
            ...
            String en_text="Elections New Brunswick, Canada";
            String fr_text="Élections Nouveau-Brunswick, Canada";
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("en")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Elections New Brunswick, Canada");    
                }
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("fr")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Élections Nouveau-Brunswick, Canada");    
                }
