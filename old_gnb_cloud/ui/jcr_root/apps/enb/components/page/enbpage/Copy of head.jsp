...
<%@page import="com.t4g.cnb.enums.Nodes"%><head>
        ...
        <meta http-equiv="coverage" content="<%=properties.get("enbCoverage","") %>">
        <meta http-equiv="publisher" content="<%=properties.get("enbPublisher","") %>">

        <%//Google Custom Search - Site Owner Verification
        String url = currentPage.getPath();
        if(url.equalsIgnoreCase("/content/enb/en")){
        %>
            <meta name="google-site-verification" content="3SW_IzqA7XxYN5XP4-Rj0sZq8tNvgdLCpLe3VpmDt_k" />
        <%}%>

        <cq:include script="/apps/enb/init/init.jsp"/>
        <script src="/etc/designs/enb/js/jquery-1.3.2.js" type="text/javascript" ></script>
        <script src="/etc/designs/enb/js/jquery.tabs.js" type="text/javascript"></script>

        <script src="/etc/designs/enb/js/jquery.cycle.all.2.72.js" type="text/javascript"></script>
        <script src="/etc/designs/enb/js/jquery-ui-1.7.2.custom.min.js" type="text/javascript"></script>
        <script src="/etc/designs/enb/js/jquery.validate.js" type="text/javascript"></script>
        <script src="/etc/designs/enb/js/jquery.cookie.js" type="text/javascript"></script>
        ...
        <link rel="stylesheet" href="/etc/designs/enb/styles/print.css" type="text/css" media="print" />
        <title><%= title %></title>
