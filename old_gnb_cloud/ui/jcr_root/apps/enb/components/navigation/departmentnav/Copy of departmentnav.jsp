...
$('#departmentNav > ul > li > a').click(function(e) {
  ...
  $('ul#departmentNav li.active ul li a:link').css('background', 'transparent url(/etc/designs/enb/images/arrow_dep_flyout.gif) no-repeat scroll center left');	 
  $('ul#departmentNav li.parent ul li a').css('background', 'transparent url(/etc/designs/enb/images/arrow_dep_flyout.gif) no-repeat scroll center left');
