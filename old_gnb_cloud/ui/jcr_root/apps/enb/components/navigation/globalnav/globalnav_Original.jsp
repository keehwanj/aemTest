...
<%
  ...
  try {
    Object categoriesPath = getLocalization("categoriesPath","/content/enb/" + lang + "/services",currentPage, log);
...
%>
  ...
  --> 
  <input type=text id="searcher" onclick="this.value='';" onkeydown="if (event.keyCode == 13) document.getElementById('btnSearch').click()"  name="searcher" value="<%=sTitle%>" class="searchText" /><br><br>
