...
<%
    ...
    if (WCMMode.fromRequest(request) == WCMMode.EDIT) {
      Locale locale = currentPage.getLanguage(true);
        ...
        if(locale !=null) {
            ...
            String en_text="Office of the Integrity Commissioner for New Brunswick, Canada";
            String fr_text="Bureau du commissaire à l’intégrité du Nouveau-Brunswick, Canada";
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("en")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Office of the Integrity Commissioner for New Brunswick, Canada");    
                }
                if(gnbPublisher_text.equals(fr_text)){
                    currentNode.setProperty("gnbPublisher","Bureau du commissaire à l’intégrité du Nouveau-Brunswick, Canada");    
                }
            }
    ...
    if ((WCMMode.fromRequest(request) == WCMMode.DISABLED || WCMMode.fromRequest(request) == WCMMode.PREVIEW) && location.length() > 0) {
        ...
        if (!location.equals(currentPage.getPath())) {
            if(location.startsWith("http")||location.startsWith("https")||location.endsWith(".pdf")) {
