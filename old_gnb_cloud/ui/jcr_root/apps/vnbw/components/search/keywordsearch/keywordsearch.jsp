...
<form action="<%=getLocalization("searchPath","/content/vnbw/"+ lang + "/search",currentPage,log)%>.html" title="<%=getLocalization("searchHint","Search GNB.ca",currentPage,log) %>" method="get" id="keyword_search_form" onsubmit="if(this.q.value=='')return false;return true">
