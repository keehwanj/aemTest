...
%>
<cq:includeClientLib css="ag.components.newssearch"/>
<cq:includeClientLib js="ag.components.newssearch"/>
<!--
...
<%
  //Account for localized images
    String localizedImagePath = "/etc/designs/agnb-vgnb/clientlib/images/";
  if (lang == "fr") {
...
<form action="${currentPage.path}.html" id="searchForm" onsubmit="return validate(this);" name="searchForm" accept-charset="utf-8">    
  <input type="hidden" name="_charset_" value="utf-8"/>
  <div class="title"><img height="15" width="15" class="reset" title="<fmt:message key="newsSearchTitle"/>" alt="<fmt:message key="newsSearchTitle"/>" src="/etc/designs/gnb/images/icon_search_grey.gif"> <!--added alt, title-->
  ...
  <div class="name">
    <label for="newsFromDate"><fmt:message key="newsStartDate" /></label>
    <input id="newsFromDate" name="newsFromDate" class="dates" value="${newsFromDate}" /> 
    <label for="newsToDate"><fmt:message key="newsEndDate" /></label> 
  ...
  <!--<select id="newsdeptId" name="newsdeptId" value="${fn:escapeXml(newsdeptId)}">--><!--removed value tag-->
  ...
  <label for="newskeyword"  class="inv"><%=encodedKeyword%></label><!--new code-->       
...
-->
        ...
        <div id="search_column_full">
          ...
          <div class="pagination"><c:if test="${fn:length(result.resultPages) > 1}">
...
<!--
                       ...
                       <c:param name="hits" value="${hits}"/>
                       </c:url>"><fmt:message key="nextText" /></a>
-->
				   	   <c:url var="theUnescapedUrl" value="${uri}">
                       <c:param name="_charset_" value="UTF-8"/>
                       <c:param name="newsFromDate" value="${newsFromDate}"/>
            ...
            <c:if test="${result.previousPage != null}">
                <div class="item">
                    <!--
                        ...
                        <c:param name="hits" value="${hits}"/>
                        </c:url>"><fmt:message key="previousText" />
                        </a>
					-->
				   	   <c:url var="theUnescapedUrl" value="${uri}">
                       <c:param name="_charset_" value="UTF-8"/>
