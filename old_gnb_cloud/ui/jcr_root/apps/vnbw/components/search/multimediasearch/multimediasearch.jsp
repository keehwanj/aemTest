...
%>
<cq:includeClientLib css="ag.components.multimediasearch"/>
<cq:includeClientLib js="ag.components.multimediasearch"/>
<!--
...
//out.write("DDDDDD_s");
  if(Utils.isNotEmpty(s)){
  	s=slingRequest.getParameter("mmFromDate").replace("%2F","/");
  ...
  if(Utils.isNotEmpty(e)){
  	e=slingRequest.getParameter("mmToDate").replace("%2F","/");
...
<div id="search_box">
  <form action="${currentPage.path}.html" id="searchForm" onsubmit="return validate(this);" name="searchForm" accept-charset="utf-8"><!--added accept-charset-->
    <input type="hidden" name="_charset_" value="utf-8">
    <div class="title">
      <!--<img height="15" width="15" class="reset" alt="" src="/etc/designs/gnb/images/icon_search_grey.gif">-->
      <!--added title, alt-->
      <img height="15" width="15" class="reset"  title="<fmt:message key="mmSearchTitle"/>" alt="<fmt:message key="mmSearchTitle"/>" src="/etc/designs/gnb/images/icon_search_grey.gif">
    ...
    <div class="name">                
        <label for="mmFromDate"><fmt:message key="mmStartDate"/></label>  <!--added for tag-->
        <input type="text" id="mmFromDate" class="dates" name="mmFromDate" value="${mmFromDate}"/>                                       
        <label for="mmToDate"><fmt:message key="mmEndDate"/></label> <!--added for tag-->                                 
    ...
    <!--<select id="mmdeptId" name="mmdeptId" value="${fn:escapeXml(mmdeptId)}">-->
      <select title="<fmt:message key="newsSearchAllDepartmentsText" />" id="mmdeptId" name="mmdeptId"><!--added title tag-->
    ...
    <input type="image" class="searchButton"  value="<fmt:message key="searchButtonText"/>" title="<fmt:message key="mmSearchButtonText"/>" alt="<fmt:message key="mmSearchButtonText"/>" src="<%=localizedImagePath%>btn_search.gif" />    
  </form>
</div>
<div id="sidebar">
