...
<div class="form-group">
  <label for="dropdown" class="control-label col-sm-5" ><%=title%></label>
  <div class="col-sm-7">  
  <select class="form-control <%=gtm_value.trim()%>" id="dropdown" name="<%=gtm_value.trim()%>" onChange="openWindow(this.value, this.options[this.selectedIndex].getAttribute('target'))">
