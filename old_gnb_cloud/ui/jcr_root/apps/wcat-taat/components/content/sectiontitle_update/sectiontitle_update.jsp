  ...
  if (style.equals("unstyled")) {
    ...
    out.write(String.format("<div class=\"%1s\">", style_1));
    	if (Utils.isNotEmpty(sectionRSSLinkUrl)) {
            ...
            out.write(String.format("<a href=\"%s\" class=\"rsslink\"><img src=\"/etc/designs/wcat-bootstrap/clientlibs/images/icon_rss.gif\" title=\"rss\" alt=\"rss\"/></a>", sectionRSSLinkUrl));
    	}
    	if (style.equals("alerts")) {%>
			<img src="/etc/designs/wcat-bootstrap/clientlibs/images/icon_alerts.gif" title="emo" alt="emo"/>
	<%}
