...
<%
    ...
    try {
        ...
        //sUrl = "https://www.nbwcat-taatnb.ca" + sUrl + selectors + ".html"; 
	...
	<div class="col-lg-5 col-md-5  col-xs-12">
		<div id="siteFooterNav" class="right">
			<ul>
                ...
                <li><a href="<%=getLocalization("privacyPath", "/content/wcat-taat/en//admin/privacy", currentPage, log)%>.html"><%=getLocalization("privacyText", "Privacy", currentPage, log)%></a></li>
                <li><a href="<%=getLocalization("disclaimerPath", "/content/wcat-taat/en//admin/disclaimer", currentPage, log)%>.html"><%=getLocalization("disclaimerText", "Disclaimer", currentPage, log)%></a></li>
			</ul>
		</div>
  	</div>
</div>   
