...
<ul>
    ...
    <%if (lang.equals("en")) {%>
    	<li class="visible-sm visible-md"><a href="/content/wcat-taat/en/search.html">Search</a></li>   
    <%}
	else{%>
    	<li class="visible-sm visible-md"><a href="/content/wcat-taat/fr/recherche.html">Recherche</a></li>   
    <%}%>
    <!--END of about us/media/search-->    

    <!--START of languageSwitcher-->    
    <li><cq:include path="languageSwitcher" resourceType="wcat-taat/components/tools/languageswitcher" /></li>
