...
<cq:include script="init.jsp" /><%
    ...
    final SimpleDateFormat outDateFormat = new SimpleDateFormat("E, dd MMM yyyy HH:mm:ss '-0400'", locale);
    ...
    //String host = "https://" + request.getServerName()+":80";    
    ...
    out.write(String.format("<language>%s</language>\n",locale));    
