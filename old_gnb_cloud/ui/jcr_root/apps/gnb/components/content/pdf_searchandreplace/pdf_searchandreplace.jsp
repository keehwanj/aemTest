...
<h3>Search and Replace Script:</h3>
	...
	<form name="purgewf" method="GET" action="">
		<table border="0">
			<tr>
				<td>Search Path:</td>
				<td><input type="text" size="100" name="search_path" value="<%=((pathToSearch != null) ? pathToSearch : "/content/dam/gnb/Departments/test")%>" width="100" /></td>
			</tr>
			<tr>
				<td>Search Component:</td>
				<td><input type="text" size="100" name="search_component" value="<%=((searchComponent != null) ? searchComponent : "")%>" width="100" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" size="70" name="replace_string" value="<%=((searchString != null) ? replaceString : "")%>" width="100" /></td>
			</tr>
			<tr>
				<td>Replace?</td>
	...
	<%
		...
		if (request.getParameter("runupdate") != null) {
            ...
            String query = "/jcr:root" + pathToSearch + "//element(*, nt:unstructured)[fn:name() = 'metadata' and @dc:format = 'application/pdf']";            
