...
$('#submit').click(function() {
    ...
    var url = location.pathname.replace(".html", "/_jcr_content.calculation.json") + "?women_no="+ women_no +"&women_dollar="+women_dollar +"&women_cent="+women_cent +"&men_no="+men_no +"&men_dollar="+men_dollar +"&men_cent="+men_cent;
    ...
    $.ajax(url, {
        ...
        <form name="signup" id="signup">
            <div>
                <label for="first" class="label">Women,s NO:</label>
                <input name="women_no" type="text" id="women_no">
            </div>
            <div>
                <label for="last" class="label">Women Dollars:</label>
                <input name="women_dollar" type="text" id="women_dollar" >
            </div>
            <div>
                <label for="last" class="label">Women Cents:</label>
                <input name="women_cent" type="text" id="women_cent" >
            </div>
            <div>
                <label for="first" class="label">Men,s NO:</label>
                <input name="men_no" type="text" id="men_no">
            </div>
            <div>
                <label for="last" class="label">Men Dollars:</label>
                <input name="men_dollar" type="text" id="women_dollar" >
            </div>
            <div>
                <label for="last" class="label">Men Cents:</label>
                <input name="men_cent" type="text" id="women_cent" >
            </div>               
