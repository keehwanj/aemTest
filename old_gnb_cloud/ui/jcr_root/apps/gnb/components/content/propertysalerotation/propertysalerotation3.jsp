    ...
    if (!list.isEmpty()) {
        ...
        try {
            ...
            while (items.hasNext()) {
                ...
                out.print("<li>");
                out.print("<div class=\"leftcontent\">");                                
                //First row (Tender No)
                /*
                ...
                */
                ...
                out.print("</div>");//leftcontent      
                
                 
                out.print("<div class=\"rightcontent\">");    
                if(!(title.equalsIgnoreCase(""))){
                    out.print("<div class=\"boldlarge\">");                
