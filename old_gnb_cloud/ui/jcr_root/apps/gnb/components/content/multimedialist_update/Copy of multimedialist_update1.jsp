    ...
    if(tabs.containsKey(tab)) {
      ...
      for(ListItem listItem : tabItems) {
        if (!alternateDisplay) {
         //Build the content
         if(rowcount==3) {
           sb.append("<div class=\"multimedia_item last\" >");
         } else {
...
//          sb.append(String.format("<a href=\"%s\"><img src=\"%s\" alt=\"%s\"></a>",listItem.getURL(), imageURL , listItem.getTitle()));
            sb.append(String.format("<a href=\"%s\"><img src=\"%s\" alt=\"%s\"></a>",href, imageURL , listItem.getTitle()));
          }
...
//            sb.append(String.format("<h2>%s</h2>", listItem.getQuicklink()));
              String navItem = String.format("<a href=\"%s\" title=\"%s\">%s</a>",href,listItem.getTitle(),listItem.getTitle());   
              sb.append(String.format("<h2>%s</h2>", navItem));
          }
...
*****************************************************************************************************************************/
              ...
              String navItem = String.format("<a href=\"%s\" title=\"%s\">%s</a>",href,listItem.getTitle(),readmore[tab-1]);   
              sb.append(String.format("<p><span class=\"more_link\">%s</span></p>", navItem));
//            sb.append(String.format("<p><span class=\"more_link\">%s</span></p>", listItem.g//etMorelink()));
/****************************************************************************************************************************
End
*****************************************************************************************************************************/     
          }
          ...
          if (rowcount == 4) {
            rowcount = 0;
            sb.append("<div class=\"clearfloats\"></div>");
          }
        } 
        else {
