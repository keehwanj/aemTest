...
try {
  ...
  if (p_deptDataNode != null && p_orgDataPage != null) {
    map.put("1_prop", "orginfo/DEPTID");
    map.put("1_prop.value", p_deptDataNode.getProperty("DEPTID").getString());
    ...
    log.error("DepartmentInfo component unable to render mandates tab.", ex);
