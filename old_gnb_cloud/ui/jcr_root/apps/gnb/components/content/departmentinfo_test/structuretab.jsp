    ...
    if (p_children.size() > 0 && p_deptDataNode != null) {
      ...
      if (p_deptDataNode.hasProperty(ORGNAME) 
          ...
          if (orgChange.equals("1")  ) {
              // *** Information currently being revised ***   //  *** Cette information est en cours de r�vision ***
      ...
      <script type='text/javascript'>
        ...
        $(document).ready(function() {
          <% out.flush(); generateGoogleDataTable(p_deptDataNode.getParent(), "chartData", 0, out, p_currentPage, p_resource, p_log);%>
        ...
        function drawChart(orgId) {
          ...
          $('.chartExpander').click(function() { drawChart($(this).attr("id").replace("chartExpander","") ); });
