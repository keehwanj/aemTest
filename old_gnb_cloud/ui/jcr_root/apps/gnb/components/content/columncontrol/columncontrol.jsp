...
%>    
	<c:choose>
		...
		<c:when test="${coltype eq '2-2-2-2-2-col'}">
			<div class="col-md-2 col-md-offset-1 ${color}"><cq:include path="col-2-2-2-2-2-1" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md-2 ${color}"><cq:include path="col-2-2-2-2-2-2" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md-2 ${color}"><cq:include path="col-2-2-2-2-2-3" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md-2 ${color}"><cq:include path="col-2-2-2-2-2-4" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md-2 last"><cq:include path="col-2-2-2-2-2-5" resourceType="/libs/foundation/components/parsys" /></div>
		</c:when>      
