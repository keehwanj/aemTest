...
$('table tbody tr  td').on('dblclick',function(){
    ...
    var art_image="/content/dam/gnb/Departments/thc-tpc/images/artbank_search/"+$(this).closest('tr').children()[1].textContent+".jpg/_jcr_content/renditions/cq5dam.web.600.400.jpeg";  
