...
<h3>Search and Replace Script:</h3>
	...
	<form name="purgewf" method="GET" action="">
		<table border="0">
			<tr>
				<td>Search Path:</td>
				<td><input type="text" size="100" name="search_path" value="<%=((pathToSearch != null) ? pathToSearch : "/content/gnb/cnb_data")%>" width="100" /></td>
			</tr>
			<tr>
	...
	<%
		...
		if (request.getParameter("runupdate") != null) {
			...
			totalprocessed += counter;%>
			<br /> Total<%=((updateRefs) ? " Updated" : "")%>:<%=totalprocessed%>, Done
	<%
		}
	%>
