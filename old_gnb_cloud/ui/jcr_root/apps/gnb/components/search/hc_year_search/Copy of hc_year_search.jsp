...
<form action="${currentPage.path}.html" id="searchForm" name="search_form">
  ...
  <select name="year_from" id="year_from">
    ...
    <label><fmt:message key="hcEndDate" /></label> 
...
<%
       for (Hit hit : result.getHits()) 
       {
           ...
           if(selectors.length>0){
               ...
               //setting the default rederering pages 
               if(type.equalsIgnoreCase("pysician_speicality")){
               ...
               if(type.equalsIgnoreCase("nursing_resources")){
               ...
               if(type.equalsIgnoreCase("allied_health_other_health_professionals")){
