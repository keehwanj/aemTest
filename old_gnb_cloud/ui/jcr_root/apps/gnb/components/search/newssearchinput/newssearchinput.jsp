...
<div class="image_box"> 
  <div class="panel panel-default">
	...
	<form class="form-horizontal searchNews"  action="<%=resultsPath%>.html" name="searchMultimedia" title="<fmt:message key="newsSearchTitle"/>" accept-charset="utf-8" role="form">
    	...
    	<!--START of keyword-->
    	<input title="<fmt:message key="newskeyword"/>" id="newskeyword_input" class="form-control searchText" type="text" name="newskeyword"  placeholder="<fmt:message key="newskeyword"/>"/>
		<!--END of keyword-->
...
<!--END from/to -News searchinput-->
<!-- START css/js for newssearch auto complete -->
<script>
    $(function () {
        ...
        $("#newskeyword_input").autocomplete({
