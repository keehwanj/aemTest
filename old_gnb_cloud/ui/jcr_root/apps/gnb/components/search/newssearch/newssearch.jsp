...
//**End of new code(2014-2-10)**/
  ...
  if (Utils.isNotEmpty(newsFromDate) && !DATE_FORMAT.equals(newsFromDate.trim())) {
    ...
    int day = cal.get(Calendar.DAY_OF_MONTH);
      //out.write("DAY-From :"+day+"<br/>");  
    int month = cal.get(Calendar.MONTH) + 1;
      //out.write("Month -From:"+month+"<br/>");  
  ...
  if (Utils.isNotEmpty(newsToDate) && !DATE_FORMAT.equals(newsToDate.trim())) {
    ...
    int day = cal.get(Calendar.DAY_OF_MONTH) + 1;
      //out.write("DAY-To :"+day+"<br/>");   
    int month = cal.get(Calendar.MONTH) + 1;
      //out.write("Month -To:"+month+"<br/>"); 
    int year = cal.get(Calendar.YEAR);
  ...
  if ((Utils.isNotEmpty(querynewsFromDate) && Utils.isNotEmpty(querynewsToDate))
    ...
    if (Utils.isNotEmpty(querynewsFromDate) && Utils.isNotEmpty(querynewsToDate)) {
      ...
      map.put("daterange.property", "jcr:content/onTime");
    ...
    if (Utils.isNotEmpty(newsdeptId)) {
      map.put("property", "@jcr:content/"+lang + "Department");
...
<!-- FIRST css/js for newssearch auto complete -->
<script>
    $(function () {
        ...
        var auto_service_search = path.replace(".html", "/_jcr_content.auto_newssearch");
        $("#newskeyword").autocomplete({
...
<!-- END css/js for newssearch auto complete -->