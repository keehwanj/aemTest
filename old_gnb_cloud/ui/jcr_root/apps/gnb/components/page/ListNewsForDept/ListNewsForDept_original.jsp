...
// out.write ("namespaceconfig = " + namespacesConfig ) ; 
String lang = "";
String lang1= "";
String serviceLang="";
    ...
    <div class="form_rightcol">
        ...
        CQ.Ext.onLoad(function() {
                ...
                inactiveTagField = new CQ.tagging.TagInputField({
                    ...
                    "width": "400",
                    "namespaces": [<%= namespacesConfig %>],
                    "tagsBasePath": "/content/data/metadata/inactive"
                });
...
<%
if (deptDataPage.contains("/content/data/metadata")) {
%>   
<div class="form_row">
    <div class="form_leftcol">
        <div class="form_leftcollabel">
