...
$("a[href$='.pdf']").each(function(index) {
	...
	pdfOnClick = "_gaq.push(['_trackEvent', 'PDF', 'PDF Download', '" + pdfLabel + "']);";
	$(this).attr("onClick", pdfOnClick);
});

$("a[href$='.doc']").each(function(index) {
	pdfLabel = $(this).attr('href');
	pdfOnClick = "_gaq.push(['_trackEvent', 'DOC', 'DOC Download', '" + pdfLabel + "']);";
	$(this).attr("onClick", pdfOnClick);
});  

$("a[href$='.docx']").each(function(index) {
	pdfLabel = $(this).attr('href');
	pdfOnClick = "_gaq.push(['_trackEvent', 'DOCX', 'DOCX Download', '" + pdfLabel + "']);";
	$(this).attr("onClick", pdfOnClick);
});    

$("a[href$='.xls']").each(function(index) {
	pdfLabel = $(this).attr('href');
	pdfOnClick = "_gaq.push(['_trackEvent', 'XLS', 'XLS Download', '" + pdfLabel + "']);";
	$(this).attr("onClick", pdfOnClick);
});    

$("a[href$='.xlsx']").each(function(index) {
	pdfLabel = $(this).attr('href');
	pdfOnClick = "_gaq.push(['_trackEvent', 'XLSX', 'XLSX Download', '" + pdfLabel + "']);";
	$(this).attr("onClick", pdfOnClick);
});    
</script> 
</html>