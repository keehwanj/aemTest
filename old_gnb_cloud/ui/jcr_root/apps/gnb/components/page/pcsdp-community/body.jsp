        ...
        <div id="main_content_wrapper">
            <div id="mainContent">
                <div class="pageHeader">
                    <br />
                    <h1>Community Event <%=item%> for <%=year%>/<%=month%>/<%=day%></h1>
                </div>
                <p><br />
...
<!--General Content-->                                    
                    ...
                    <tr><td width="30%">Ongoing?</td><td width="70%"><%=properties.get("ongoing","&nbsp;")%></td></tr>
...
<!--English Content-->
                    ...
                    <tr><td>Other (ie: Facebook / Twitter)</td><td><%=properties.get("other_en","&nbsp;")%></td></tr>    
                    <tr><td>Date / Time</td><td><%=properties.get("date_time_en","&nbsp;")%></td></tr>                        
                    <tr><td>Registration Deadline</td><td><%=properties.get("deadline_en","&nbsp;")%></td></tr>                                            
                    <tr><td>Fee</td><td><%=properties.get("fee_en","&nbsp;")%></td></tr>                                                                
...
<!--French Content-->                    
                    ...
                    <tr><td>Other (ie: Facebook / Twitter)</td><td><%=properties.get("other_fr","&nbsp;")%></td></tr>    
                    <tr><td>Date / Time</td><td><%=properties.get("date_time_fr","&nbsp;")%></td></tr>                        
                    <tr><td>Registration Deadline</td><td><%=properties.get("deadline_fr","&nbsp;")%></td></tr>                                            
                    <tr><td>Fee</td><td><%=properties.get("fee_fr","&nbsp;")%></td></tr>                                                                
                    <tr><td>Description</td><td>
                        <%out.print("<div class=\"extrainfo\">");%>
