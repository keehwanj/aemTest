...
==============================================================================
  ...
  Onsite Sewage Innorth component
==============================================================================
--%>
...
String sDBQ = "C:\\database\\doh\\onsitesewage\\north.mdb";
...
while (rs.next()) 
    ...
    phone_no         ="506-"+phone_no;   
    type_license     =rs.getString("type_license");                
    
    //creating node
    final Node gnbNode = WCMUtils.getNode(resourceResolver.getResource("/content/gnb/doh-data/data/north"));    
    nodeIter = gnbNode.getNodes();
    out.print(nodeIter.getSize());
    out.print("<br/>");    


    gnbNode.addNode("n"+id, Nodes.PAGE.nodeType());//change 11 with id
    gnbNode.save();

    //setting jcr:content node
    final Node jcrContentNode = gnbNode.getNode("n"+id);//change the "11" with id   
