...
<ul>
    ...
    <li><a href="<%=getLocalization("privacyPath", "/content/gnb/en/privacy.html", currentPage, log)%>"><%=getLocalization("privacyText", "Privacy", currentPage, log)%></a></li>
    <li><a href="<%=getLocalization("disclaimerPath", "/content/gnb/en/disclaimer.html", currentPage, log)%>"><%=getLocalization("disclaimerText", "Disclaimer", currentPage, log)%></a></li>
</ul>
</div>
