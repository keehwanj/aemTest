...
<%
  if (style.equals("unstyled")) {
    ...
    out.write(String.format("<div class=\"%1s\">", style));
    out.write("<div class=\"rightcurve\">&nbsp;</div>");
    if (Utils.isNotEmpty(sectionRSSLinkUrl)) {
      if(!sectionRSSLinkUrl.contains(".")) sectionRSSLinkUrl += ".feed.rss.xml";
      out.write(String.format("<a href=\"%s\" class=\"rsslink\"><img src=\"/etc/designs/gnb/images/icon_rss.gif\" /></a>", sectionRSSLinkUrl));
    }
    out.write(String.format("<div class=\"leftcurve\"><h3 class=\"title\">%s</h3>", sectionTitle));
