    ...
    if(!setting.equals("/")) {
        ...
        if(oppositePage!=null) {
            ...
            if(oppositeNode!=null && oppositeNode.hasNode("jcr:content")) {
                if(!oppositeNode.getNode("jcr:content").hasNode("languageSwitcher")) {
                    oppositeNode.getNode("jcr:content").addNode("languageSwitcher");
                    oppositeNode.save();
                }
                Node langSwitcher = oppositeNode.getNode("jcr:content").getNode("languageSwitcher");
...
try{
    ...
    while (myPage != null) {
        ...
        if(myNode!=null && myNode.hasNode("jcr:content") && myNode.getNode("jcr:content").hasNode("languageSwitcher")) {
            Property prop = myNode.getNode("jcr:content").getNode("languageSwitcher").getProperty("oppositePage");
