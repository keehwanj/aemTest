...
<%}%>    
    ...
    if(url.equalsIgnoreCase("/content/nbpc-cqnb")){ %>
	...
	<cq:includeClientLib categories="nbpc.bootstrap.all"/>    


	<link rel="shortcut icon" href="/etc/designs/nbpc-bootstrap/clientlibs/favicon.ico" type="image/x-icon" />
