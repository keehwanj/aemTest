...
<%!protected String getLocalization(String key, String defaultValue, Page currentPage, Logger log) {
        try {
            ...
            while (myPage != null) {
                ...
                if (myNode != null && myNode.hasNode("jcr:content") && myNode.getNode("jcr:content").hasNode("nbpc_siteFooter") && myNode.getNode("jcr:content").getNode("nbpc_siteFooter").hasProperty(key)) {
                    Property prop = myNode.getNode("jcr:content").getNode("nbpc_siteFooter").getProperty(key);
