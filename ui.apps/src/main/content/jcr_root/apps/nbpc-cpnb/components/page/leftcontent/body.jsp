        ...
        <div id="main_content_wrapper">
    		...
    		<div class="row">
      			<div class="col-sm-8">
            		...
            		<div id="mainContent">
                		<div id="leftcontentwrapper">
                    		...
                    		<cq:include path="nbpc_mainContent_par" resourceType="foundation/components/parsys"/>
      			...
      			<div class="col-sm-4">
            		<!-- START of sidebar -->
            		<div id="sidebar">
                		<cq:include path="nbpc_secondaryNav_ipar" resourceType="foundation/components/iparsys"/>
                		<cq:include path="nbpc_secondaryContent_par" resourceType="foundation/components/parsys"/>
            		</div> 
            		<!-- END of sidebar -->          
      			</div><!--col-sm-4-->  
    		</div><!--row-->  
