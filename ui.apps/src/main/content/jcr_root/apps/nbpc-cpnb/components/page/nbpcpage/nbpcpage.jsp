    ...
    if (WCMMode.fromRequest(request) == WCMMode.EDIT) {
      Locale locale = currentPage.getLanguage(true);
        ...
        if(locale !=null) {
            ...
            String en_text="New Brunswick Police Commission, Canada";
            String fr_text="Commission de police du Nouveau-Brunswick, Canada";
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("en")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","New Brunswick Police Commission, Canada");    
                }
                if(gnbPublisher_text.equals(fr_text)){
                    currentNode.setProperty("gnbPublisher","Commission de police du Nouveau-Brunswick, Canada");    
                }
            }
