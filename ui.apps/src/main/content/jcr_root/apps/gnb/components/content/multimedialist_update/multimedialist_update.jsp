...
%><link rel="alternate" type="application/rss+xml" title="<%=title %>" href="<%=resource.getPath()%>.rss1.html" /><%
}
...
*****************************************************************************************************************************/     
          ...
          if (Utils.isNotEmpty(listItem.getDescription(descriptionLimit))){
              sb.append(String.format("<p class=\"visible-lg visible-md\">%s</p>", listItem.getDescription(descriptionLimit)));
          }
