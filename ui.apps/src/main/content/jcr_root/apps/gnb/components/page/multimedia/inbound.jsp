...
<%
  ...
  try {
    ...
    Resource engres = resourceResolver.getResource("/content/cq:tags/gnb-eng/organizations");
    Resource frares = resourceResolver.getResource("/content/cq:tags/gnb-fra/organisation");
