...
//final String mmdeptId = Utils.nullReplace(slingRequest.getParameter("mmdeptId"));
  ...
  if ((Utils.isNotEmpty(querymmFromDate) && Utils.isNotEmpty(querymmToDate))
    ...
    if (Utils.isNotEmpty(querymmFromDate) && Utils.isNotEmpty(querymmToDate)) {
      map.put("daterange.property", "jcr:content/metadata/dam:newDate");
    ...
    if (Utils.isNotEmpty(mmdeptId)) {
      map.put("property", "@jcr:content/metadata/dam:dept");
      map.put("property.value", mmdeptId);
    }

    map.put("orderby", "@jcr:content/metadata/dam:newDate");
    ...
    */
    ...
    for (Hit hit : result.getHits()) {
      cal.clear();
        Node metaNode = WCMUtils.getNode(resourceResolver.getResource(hit.getPath()+"/jcr:content/metadata"));
  ...
  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
	...
	<div id="search_box">
		...
		<form action="${currentPage.path}.html" class="form-horizontal searchNews" name="searchForm" title="<fmt:message key="mmSearchTitle"/>" accept-charset="utf-8" role="form">
    		...
    		<button type="submit" class="btn btn-default btn-sm center-block newsButton"><span class="glyphicon glyphicon-search"></span><fmt:message key="mmSearchButtonText"/></button>
                    ...
                    for (ListItem listItem : mmItems) {
                      ...
                      if (Utils.isNotEmpty(listItem.getImageURL())) {                                                                        
                        Node assetNode = WCMUtils.getNode(resourceResolver.getResource(listItem.getImageURL()));
						  ...
						  String photo2Download=metadata.hasProperty(Multimedia.PHOTO_2_DOWNLOAD.toString())? metadata.getProperty(Multimedia.PHOTO_2_DOWNLOAD.toString()).getString():"";
                          String photo3Download=metadata.hasProperty(Multimedia.PHOTO_3_DOWNLOAD.toString())? metadata.getProperty(Multimedia.PHOTO_3_DOWNLOAD.toString()).getString():"";
                          String news=metadata.hasProperty(Multimedia.NEWS_RELEASE.toString())? metadata.getProperty(Multimedia.NEWS_RELEASE.toString()).getString():"";
                          String videoFileNameO=metadata.hasProperty(Multimedia.VIDEOFILENAME_O.toString())? metadata.getProperty(Multimedia.VIDEOFILENAME_O.toString()).getString():"";
                          String videoFileNameE=metadata.hasProperty(Multimedia.VIDEOFILENAME_E.toString())? metadata.getProperty(Multimedia.VIDEOFILENAME_E.toString()).getString():"";
                          String videoFileNameF=metadata.hasProperty(Multimedia.VIDEOFILENAME_F.toString())? metadata.getProperty(Multimedia.VIDEOFILENAME_F.toString()).getString():"";
                          String audioFileNameO =metadata.hasProperty(Multimedia.AUDIOFILENAME_O.toString())? metadata.getProperty(Multimedia.AUDIOFILENAME_O.toString()).getString():"";
                          String audioFileNameE =metadata.hasProperty(Multimedia.AUDIOFILENAME_E.toString())? metadata.getProperty(Multimedia.AUDIOFILENAME_E.toString()).getString():"";
                          String audioFileNameF =metadata.hasProperty(Multimedia.AUDIOFILENAME_F.toString())? metadata.getProperty(Multimedia.AUDIOFILENAME_F.toString()).getString():"";
                          String presentationFileNameE =metadata.hasProperty(Multimedia.PRESENTATIONFILENAME_E.toString())? metadata.getProperty(Multimedia.PRESENTATIONFILENAME_E.toString()).getString():"";
                          String presentationFileNameF =metadata.hasProperty(Multimedia.PRESENTATIONFILENAME_F.toString())? metadata.getProperty(Multimedia.PRESENTATIONFILENAME_F.toString()).getString():"";
                          String gallery1 =metadata.hasProperty(Multimedia.GALLERY_1.toString())? metadata.getProperty(Multimedia.GALLERY_1.toString()).getString():"";
                          String gallery2 =metadata.hasProperty(Multimedia.GALLERY_2.toString())? metadata.getProperty(Multimedia.GALLERY_2.toString()).getString():"";
                          String gallery3 =metadata.hasProperty(Multimedia.GALLERY_3.toString())? metadata.getProperty(Multimedia.GALLERY_3.toString()).getString():"";
                          //END NEW
                        ...
                        if (Utils.isNotEmpty(listItem.getURL())) {
                          ...
                          if(Utils.isNotEmpty(photo2Download)){
                             ListItem photoLI = new ListItem(photo2Download, currentPage, resource);
                            sb.append(String.format("<a class=\"photo\" href=\"%s\" >", listItem.getURL()+ "?dphoto=2")).append("| Photo 2 </a>");
                          }
                          if(Utils.isNotEmpty(photo3Download)){
                           ListItem photoLI = new ListItem(photo3Download, currentPage, resource);
                        ...
                        sb.append("<div class=\"mm_assets\">");//START of mm_assets
                           if(news!=""){/**added alt tags for all images**/
                          ...
                          if(Utils.isNotEmpty(videoFileNameO) ||Utils.isNotEmpty(videoFileNameE) ||Utils.isNotEmpty(videoFileNameF)){
                          ...
                          if(Utils.isNotEmpty(audioFileNameO) ||Utils.isNotEmpty(audioFileNameE) ||Utils.isNotEmpty(audioFileNameF)){
                         ...
                         if(Utils.isNotEmpty(presentationFileNameE) ||Utils.isNotEmpty(presentationFileNameF)){
                          ...
                          if(Utils.isNotEmpty(gallery1) ||Utils.isNotEmpty(gallery2) ||Utils.isNotEmpty(gallery3)){
...
<!-- START css/js for multimedia auto complete -->
<script>
    $(function () {
        ...
        var auto_service_search = path.replace(".html", "/_jcr_content.auto_multimediasearch");
        $("#mmkeyword").autocomplete({
...
<!-- END css/js for multimedia auto complete -->
