...
String r_1_3_pac		= properties.get("r_1_3_pac", "Per Month");
  ...
  <form method="POST" class="form-horizontal" role="form" >
    ...
    <div class="well well-sm">
      ...
      <div class="form-group">
        ...
        <label class="col-sm-6 bold"><%=title_4_pac%></label>
        <%} else {%>
        <label class="col-sm-6 bold"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=title_4_tootip_pac%>" class="red-tooltip"><%=title_4_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
          <div class="textRight"><small><%=r_1_2_pac%></small></div>
        </div>
        <div class="col-sm-3">
          <div class="textRight"><small><%=r_1_3_pac%></small></div>
        </div>          
      </div>
      ...
      <div class="form-group">        
        <%if (r_1_tootip_1_pac=="") {%>
        <label class="col-sm-6 bold"><%=r_1_1_pac%></label>
        <%} else {%>
        <label class="col-sm-6 bold"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=r_1_tootip_1_pac%>" class="red-tooltip"><%=r_1_1_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
          <div class="textRight  normal" id="daily_expenses"></div>
        </div>
        <div class="col-sm-3">
          <div class="textRight  normal" id="monthly_expenses"></div>
        </div>          
        <!--END of row-->
      </div>
      ...
      <div class="form-group">        
        <%if (r_2_tootip_2_pac=="") {%>
        <label class="col-sm-6"><%=r_2_2_pac%></label>
        <%} else {%>
        <label class="col-sm-6"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=r_2_tootip_2_pac%>" class="red-tooltip"><%=r_2_2_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="hidden-sm hidden-md hidden-lg"><small><%=r_2_4_pac%></small></div>
          <div class="row">
            <div class="col-sm-12 textRight  normal" id="DayCare_Assistance_perMonth"></div>
          </div>
        </div>
      </div>          
        <!--END of row-->
      ...
      <div class="form-group">        
        <%if (r_2_tootip_3_pac=="") {%>
        <label class="col-sm-6 "><%=r_2_3_pac%></label>
        <%} else {%>
        <label class="col-sm-6"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=r_2_tootip_3_pac%>" class="red-tooltip"><%=r_2_3_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
          <div class="hidden-sm hidden-md hidden-lg"><small><%=r_2_4_pac%></small></div>
          <div class="row">
        ...
        <div class="col-sm-3">
          <div class="hidden-sm hidden-md hidden-lg"><small><%=r_2_4_pac%></small></div>
          <div class="row">
            <div class="col-sm-12 textRight  normal" id="IncomeCap_Assistance_perMonth"></div>
          </div>
        </div>
      ...
      <div class="form-group">        
        <%if (r_3_tootip_1_pac=="") {%>
        <label class="col-sm-6  bold"><%=r_3_1_pac%></label>
        <%} else {%>
        <label class="col-sm-6 bold"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=r_3_tootip_1_pac%>" class="red-tooltip"><%=r_3_1_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="hidden-sm hidden-md hidden-lg"><small><%=r_3_2_pac%></small></div>
          <div class="row">
            <div class="col-sm-12 textRight  normal" id="Total_EstimatedAssistance_perMonth"></div>
          </div>
        </div>          
      ...
      <div class="form-group">        
        <%if (r_4_tootip_1_pac=="") {%>
        <label class="col-sm-6  bold"><%=r_4_1_pac%></label>
        <%} else {%>
        <label class="col-sm-6 bold"><a href="#" data-toggle="tooltip" data-placement="bottom" title="<%=r_4_tootip_1_pac%>" class="red-tooltip"><%=r_4_1_pac%></a></label>
        <% } %>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="hidden-sm hidden-md hidden-lg"><small><%=r_4_2_pac%></small></div>
          <div class="row">
            <div class="col-sm-12 textRight  normal" id="Revised_Estimated_Annual_Daycare_perMonth"></div>
          </div>
        </div>
      </div>  
        <!--END of row-->
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor1_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor1_PT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor1_FT_PRE"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor1_PT_PRE"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor2_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor2_PT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor2_FT_PRE"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor2_PT_PRE"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor3_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor3_PT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor3_FT_PRE"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Factor3_PT_PRE"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Assistance_Estimate_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Assistance_Estimate_PT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Assistance_Estimate_FT_PRE"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Assistance_Estimate_PT_PRE"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Daily_Expense_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PreSch</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Daily_Expense_FT_PreSch"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Daily_Expense_PT_INF"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Daily_Expense_PT_PreSch"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Total_Subsidy_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PreSch</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Total_Subsidy_FT_PreSch"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Total_Subsidy_PT_INF"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Total_Subsidy_PT_PreSch"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Net_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PreSch</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Net_FT_PreSch"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Net_PT_INF"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Net_PT_PreSch"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Days_in_Care_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PreSch</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Days_in_Care_FT_PreSch"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Days_in_Care_PT_INF"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Days_in_Care_PT_PreSch"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
...
<!--START Testing-->
    ...
    <div class="row normal bg-success">
    	<div class="col-sm-3">
            <div class=""><small>FT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Annaulized_Subsidy_FT_INF"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>FT_PreSch</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Annaulized_Subsidy_FT_PreSch"></div>    
            </div>
    	</div>
    	<div class="col-sm-3">
			<div class=""><small>PT_INF</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Annaulized_Subsidy_PT_INF"></div>    
            </div>
    	</div>  
    	<div class="col-sm-3">
			<div class=""><small>PT_PRE</small></div>
			<div class="row">
                <div class="col-sm-12 textRight" id="Annaulized_Subsidy_PT_PreSch"></div>    
            </div>
    	</div>          
    </div>
    <!--END of row-->  
