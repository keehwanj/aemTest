...
String config_path="/content/gnb/cnb_data/emo-warning/";
...
<%
    //itemPath = String.format("%s/%s", config_path, "23");
}else{
...
if (itemPage != null) {
    ...
    if(warning.equals("true")){
        ...
        description	=props.get(lang + "_description","").toString();
        body		=props.get(lang + "_body","").toString();
    }else{
		title		=props.get(lang + "_title_normal","").toString();
        body		=props.get(lang + "_description_normal","").toString();
    }
