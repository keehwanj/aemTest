...
<div class="image_box"> 
  <div class="panel panel-default">
	...
	<form class="form-horizontal searchNews"  action="<%=resultsPath%>.html" name="searchMultimedia" title="<fmt:message key="multimediaSearchTitle"/>" accept-charset="utf-8" role="form">
    	...
    	<!--START of keyword-->
    	<input title="<fmt:message key="multimediakeyword"/>" id="mmkeyword_input" class="form-control searchText" type="text" name="mmkeyword"  placeholder="<fmt:message key="multimediakeyword"/>"/>
		<!--END of keyword-->
