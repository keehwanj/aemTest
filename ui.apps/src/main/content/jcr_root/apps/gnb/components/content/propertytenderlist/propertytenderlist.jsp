        ...
        try {
            ...
            while (items.hasNext()) {
               ...
               //String map = (String) props.get("map","");   
                ...
                imageURL=String.format("<a href=\"%s\"><img class=\"img-responsive\" src=\"%s\" alt=\"%s\"></a>",href, imageURL , "Title");  
                ...
                out.print("<tr><td width='33%' class='first'>");
                ...
                out.print("<td width='67%' class='first'>");
