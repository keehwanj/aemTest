...
<h3>Search and Replace Script:</h3>
	...
	<form name="purgewf" method="GET" action="">
		<table border="0" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td>
					<input type="text" class="form-control" name="search_component" value="<%=((searchComponent != null) ? searchComponent : "")%>" >
			</tr>
			<tr>
				<td>Search Element:</td>
				<td>
                    <input type="text" class="form-control" name="search_element" value="<%=((searchElement != null) ? searchElement : "cq:PageContent")%>" >
                </td>
			</tr>
			<tr>
				<td>Search Type: (static or dynamic)</td>
                <td>
                    <input type="text" class="form-control" name="search_type" value="<%=((searchType != null) ? searchType : "static")%>" >
                </td>
			</tr>
			<tr>
				<td>Search String:</td>
				<td>
                    <input type="text" class="form-control" name="search_string" value="<%=((searchString != null) ? searchString : "gnb-eng:")%>" >

                    Dynamic Example: sab=\"[0-9]*\"</td>
			</tr>
			<tr>
	...
	<%
		...
		if (request.getParameter("runupdate") != null) {
            ...
            String query = "/jcr:root" + pathToSearch + "//element(*, nt:unstructured)[fn:name() = 'metadata' and @dc:format = 'image/jpeg']";
