    ...
    if (configurationPage != null) {
      if (configurationPage.getProperties().get("contactDataPage") != null
        ...
        if (currentNode.getParent().hasNode("contactinfo")) {
          ...
          if (contactDataNode.hasProperty("PUBLISHEDPHONEAREA") && Utils.isNotEmpty(contactDataNode.getProperty("PUBLISHEDPHONEAREA").getString()) && 
              contactDataNode.hasProperty("PUBLISHEDPHONE") && Utils.isNotEmpty(contactDataNode.getProperty("PUBLISHEDPHONE").getString()))
            phone = "P: (" + contactDataNode.getProperty("PUBLISHEDPHONEAREA").getString() + ") " +  contactDataNode.getProperty("PUBLISHEDPHONE").getString();
          if (contactDataNode.hasProperty("FAXAREACODE") && Utils.isNotEmpty(contactDataNode.getProperty("FAXAREACODE").getString()) &&
              contactDataNode.hasProperty("FAX") && Utils.isNotEmpty(contactDataNode.getProperty("FAX").getString()))
            fax = "F: (" + contactDataNode.getProperty("FAXAREACODE").getString() + ") " +  contactDataNode.getProperty("FAX").getString();
      ...
      if (configurationPage.getProperties().get("organisationDataPage") != null
        ...
        if (currentNode.getParent().hasNode("orginfo")) {
          ...
          if (orgDataNode.hasProperty("RECAREACODE") && orgDataNode.hasProperty("RECPHONE") &&
              Utils.isNotEmpty(orgDataNode.getProperty("RECAREACODE").getString()) &&  Utils.isNotEmpty(orgDataNode.getProperty("RECPHONE").getString()))
            phone = "P: (" + orgDataNode.getProperty("RECAREACODE").getString() + ") " +  orgDataNode.getProperty("RECPHONE").getString();
          if (orgDataNode.hasProperty("TOLLFREEPHONE") && Utils.isNotEmpty(orgDataNode.getProperty("TOLLFREEPHONE").getString()))
            phone = "P: " + orgDataNode.getProperty("TOLLFREEPHONE").getString();
          if (orgDataNode.hasProperty("FAXAREACODE") && orgDataNode.hasProperty("FAX") &&
              Utils.isNotEmpty(orgDataNode.getProperty("FAXAREACODE").getString()) &&  Utils.isNotEmpty(orgDataNode.getProperty("FAX").getString()))
            fax = "F: (" + orgDataNode.getProperty("FAXAREACODE").getString() + ") " +  orgDataNode.getProperty("FAX").getString();
