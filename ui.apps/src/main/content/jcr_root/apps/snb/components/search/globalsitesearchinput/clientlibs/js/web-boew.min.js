...
(window.Modernizr = (function (a, b, c) {
    ...
    var e = function (a) {
      ...
      j = (function () {
        for (
          ...
          (d.innerHTML =
            "\x3c!--[if gt IE " + (b += 1) + "]><i></i><![endif]--\x3e"),
            e[0];
                ...
                (f.one("timerpoke.wb wb-init." + a, d, function () {
                  m.init(c, a, d),
                    Modernizr.load({
                      ...
                      testReady: function () {
                        return b.MathJax && b.MathJax.isReady;
                      },
                      complete: function () {
                        m.ready(f, a);
                      },
  ...
  (function (a, b) {
    "use strict";
    b.doc.on("ajax-fetch.wb", function (c) {
      var d,
        e,
        f,
        g,
