...
<%
  ...
  try {
    Object categoriesPath = getLocalization("categoriesPath","/content/snb/" + lang + "/services",currentPage, log);
...
<ul>
    ...
    <li class="visible-sm visible-md"><a href="//www2.gnb.ca/content/gnb/en/search.html">Search</a></li>   
    	<li class="visible-xs visible-sm visible-md"><a href="/content/snb/en/services.html">Services</a></li>      
    ...
    <%}
    	...
    	<li class="visible-xs visible-sm visible-md"><a href="/content/snb/fr/services.html">Services</a></li>      
    ...
    <li><cq:include path="languageSwitcher" resourceType="snb/components/tools/languageswitcher" /></li>
...
%>  
    ...
    <%if (lang.equals("en")) {%>
    	<li class="visible-sm visible-md visible-lg"><a href="//www2.gnb.ca/content/gnb/en.html">GNB Home</a></li>   
    <%}
	else{%>
    	<li class="visible-sm visible-md visible-lg"><a href="//www2.gnb.ca/content/gnb/fr.html">Accueil GNB</a></li>   
    <%}%>
	<!--END of home page-->    
...
<%
  ...
  try {
    Object legislaturePath = getLocalization("legislaturePath","/content/gnb/" + lang + "/redirects/legislature",currentPage, log);
    Object courtsPath = getLocalization("courtsPath","/content/gnb/" + lang + "/redirects/courts",currentPage, log);
    Object otherPath = getLocalization("otherPath","/content/gnb/" + lang + "/redirects/other",currentPage, log);
    if(legislaturePath!=null && legislaturePath instanceof String) {
      ...
      Page legislaturePage = currentPage.getPageManager().getPage((String)legislaturePath);
        /*  
      out.write((String)legislaturePath);  
      out.write("<br/>");
      out.write((String)courtsPath);  
	  out.write("<br/>");
      out.write((String)otherPath); 
        */
...
$(document).ready(function(){
    //2020-9-28
    //let deptHeight = $("#panel_dep").height()-35;
    //let catHeight = $("#panel_cat").height()-35;
    let deptHeight = ($("#panel_dep").height()-35)/2;
    let catHeight = ($("#panel_cat").height()-35)/2;
...
function goToSearch(obj, sLang){
    location.href='/content/snb/' + sLang + '/services.html?keyword=' + document.getElementById('searcher').value;
} 
</script>
...
<script>
    //2020-9-28
    $("#panel_dep #bkgr_span ul").css('list-style', "none"); 
    $("#panel_cat #bkgr_span1 ul").css('list-style', "none"); 
</script>