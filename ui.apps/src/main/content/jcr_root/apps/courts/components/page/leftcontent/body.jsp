    		...
    		<div class="row">
      			...
      			<div class="col-sm-4">
            		...
            		<div id="sidebar">
                		...
                		<cq:include path="secondaryNav_ipar_courts" resourceType="foundation/components/iparsys"/>
                		<cq:include path="secondaryContent_par_courts" resourceType="foundation/components/parsys"/>
            		</div> 
            		<!-- END of sidebar -->          
      			</div><!--col-sm-4-->  
    		</div><!--row-->  
