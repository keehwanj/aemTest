...
%>
<form action="<%=getLocalization("searchPath","/content/agnb-vgnb/"+ lang + "/search",currentPage,log)%>.html" title="<%=getLocalization("searchHint","Search GNB.ca",currentPage,log) %>" method="get" id="keyword_search_form" onsubmit="if(this.q.value=='')return false;return true">
	...
	<%if(lang=="fr") { %>
		<input type="hidden" name="cx" value="004686105439310941724:kwdezo2rzkm" />
	<%}else{ %>
		<input type="hidden" name="cx" value="004686105439310941724:vjorlpwulkq" />
	<%} %>
