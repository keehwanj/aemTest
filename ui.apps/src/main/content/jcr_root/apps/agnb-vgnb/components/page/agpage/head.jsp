...
<%}%>    
    ...
    if(url.equalsIgnoreCase("/content/agnb-vgnb")){ %>
    	<meta name="google-site-verification" content="9klqz58Yi-7C5_9UDZkB9f9kgJiq_v29qtOrfcHu3JE" />
	<%}%>

	<cq:include script="/apps/gnb/init/init.jsp"/>
	<cq:includeClientLib categories="agnb.bootstrap.all"/>    
	<script src='//www.google.com/jsapi' type='text/javascript' ></script>    

	<link rel="shortcut icon" href="/etc/designs/agnb-bootstrap/clientlibs/favicon.ico" type="image/x-icon" />
