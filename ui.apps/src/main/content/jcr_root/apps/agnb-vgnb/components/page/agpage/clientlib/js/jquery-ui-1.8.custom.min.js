/**START of jquery-ui-1.8.custom.min.js**/
/*!
 * jQuery UI 1.8
 *
      ...
      focusable: function (c) {
        ...
        return (
          (/input|select|textarea|button|object/.test(d)
            ...
            : 'a' == d || 'area' == d
            ? c.href || !isNaN(b)
            : !isNaN(b)) && !a(c)['area' == d ? 'parents' : 'closest'](':hidden').length
        );
      },
      tabbable: function (c) {
...
(function (b) {
  ...
  b.widget = function (d, f, c) {
    ...
    b[e][d].prototype = b.extend(
      true,
      g,
      { namespace: e, widgetName: d, widgetEventPrefix: b[e][d].prototype.widgetEventPrefix || d, widgetBaseClass: h },
      c
    );
  ...
  b.Widget.prototype = {
    ...
    _setOption: function (c, d) {
      ...
      if (c === 'disabled') {
        this.widget()
          [d ? 'addClass' : 'removeClass'](this.widgetBaseClass + '-disabled ' + this.namespace + '-state-disabled')
...
(function (a) {
  a.widget('ui.mouse', {
      ...
      var c = this,
        ...
        b =
          typeof this.options.cancel == 'string'
            ? a(d.target).parents().add(d.target).filter(this.options.cancel).length
            : false;
    ...
    _mouseDistanceMet: function (b) {
      return (
        Math.max(Math.abs(this._mouseDownEvent.pageX - b.pageX), Math.abs(this._mouseDownEvent.pageY - b.pageY)) >=
  ...
  if (!f.offset.setOffset) {
    f.offset.setOffset = function (l, i) {
      ...
      var k = f(l),
        ...
        j = { top: i.top - n.top + h, left: i.left - n.left + m };
      if ('using' in i) {
        i.using.call(l, j);
      } else {
        k.css(j);
    ...
    _setContainment: function () {
      ...
      if (e.containment == 'document' || e.containment == 'window') {
        this.containment = [
          ...
          a(e.containment == 'document' ? document : window).width() - this.helperProportions.width - this.margins.left,
      ...
      return {
        top:
          ...
          (a.browser.safari && a.browser.version < 526 && this.cssPosition == 'fixed'
            ? 0
            : (this.cssPosition == 'fixed' ? -this.scrollParent.scrollTop() : g ? 0 : b.scrollTop()) * c),
        left:
          h.left +
          ...
          (a.browser.safari && a.browser.version < 526 && this.cssPosition == 'fixed'
            ? 0
            : (this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : g ? 0 : b.scrollLeft()) * c),
      };
    },
    ...
    drag: function (u, p) {
      ...
      for (var v = g.snapElements.length - 1; v >= 0; v--) {
        ...
        if (q.snapMode != 'inner') {
          ...
          if (c) {
            p.position.top =
              g._convertPositionTo('relative', { top: m - g.helperProportions.height, left: 0 }).top - g.margins.top;
          }
          if (z) {
          ...
          if (j) {
            p.position.left =
              g._convertPositionTo('relative', { top: 0, left: s - g.helperProportions.width }).left - g.margins.left;
          }
          if (k) {
        ...
        if (q.snapMode != 'outer') {
          ...
          if (z) {
            p.position.top =
              g._convertPositionTo('relative', { top: A - g.helperProportions.height, left: 0 }).top - g.margins.top;
          }
          if (j) {
          ...
          if (k) {
            p.position.left =
              g._convertPositionTo('relative', { top: 0, left: n - g.helperProportions.width }).left - g.margins.left;
          }
        }
      ...
      this.element
        ...
        .each(function () {
          ...
          if (
            f.options.greedy &&
            !f.options.disabled &&
            f.options.scope == b.options.scope &&
...
(function (c) {
  c.widget('ui.resizable', c.ui.mouse, {
      ...
      this._renderAxis = function (p) {
        ...
        for (var m in this.handles) {
          ...
          if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
            ...
            var l = [
              'padding',
              /ne|nw|n/.test(m) ? 'Top' : /se|sw|s/.test(m) ? 'Bottom' : /^e$/.test(m) ? 'Right' : 'Left',
            ].join('');
            p.css(l, o);
            this._proportionallyResize();
          }
    ...
    _mouseStart: function (f) {
      ...
      this.aspectRatio =
        typeof i.aspectRatio == 'number' ? i.aspectRatio : this.originalSize.width / this.originalSize.height || 1;
  ...
  a.widget('ui.sortable', a.ui.mouse, {
    ...
    _intersectsWith: function (m) {
      ...
      if (
        ...
        (this.options.tolerance != 'pointer' &&
          this.helperProportions[this.floating ? 'width' : 'height'] > m[this.floating ? 'width' : 'height'])
      ) {
        return g;
      } else {
        return (
...
(function (f) {
  var d,
    ...
    b =
      'ui-state-hover ui-state-active ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon ui-button-text-only',
    e = function (g) {
    ...
    _resetButton: function () {
      ...
      if (h.primary || h.secondary) {
        ...
        if (!this.options.text) {
          j.addClass(g ? 'ui-button-icons-only' : 'ui-button-icon-only').removeClass(
...
(function (b) {
  ...
  b.widget('ui.dialog', {
    ...
    _create: function () {
      ...
      var k = this,
        ...
        h = b('<a href="#"></a>')
          ...
          .appendTo(e),
        g = (k.uiDialogTitlebarCloseText = b('<span></span>'))
    ...
    open: function () {
      ...
      b([])
        .add(c.find('.ui-dialog-content :tabbable:first'))
        .add(c.find('.ui-dialog-buttonpane :tabbable:first'))
        .add(c)
        .filter(':first')
        .focus();
      d._trigger('open');
    ...
    _createButtons: function (f) {
      ...
      if (c) {
        b.each(f, function (g, i) {
          var h = b('<button type="button"></button>')
            .text(g)
            .click(function () {
    ...
    _size: function () {
      ...
      this.element
        .css(
          d.height === 'auto'
            ? { minHeight: Math.max(d.minHeight - c, 0), height: 'auto' }
            : { minHeight: 0, height: Math.max(d.height - c, 0) }
        )
        .show();
  ...
  b.extend(b.ui.dialog.overlay, {
    ...
    maxZ: 0,
    events: b
      .map('focus,mousedown,mouseup,keydown,keypress,click'.split(','), function (c) {
    ...
    create: function (d) {
      ...
      var c = (this.oldInstances.pop() || b('<div></div>').addClass('ui-widget-overlay'))
        .appendTo(document.body)
  ...
  c.widget('ui.tabs', {
    ...
    _tabify: function (q) {
      ...
      for (var j = 0, p; (p = this.lis[j]); j++) {
        c(p)[c.inArray(j, f.disabled) != -1 && !c(p).hasClass('ui-tabs-selected') ? 'addClass' : 'removeClass'](
          'ui-state-disabled'
        );
      }
      if (f.cache === false) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _dialogDatepicker: function (input, date, onSelect, settings, pos) {
      ...
      if (!inst) {
        var id = 'dp' + ++this.uuid;
        this._dialogInput = $(
          '<input type="text" id="' + id + '" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>'
        );
...
jQuery.effects ||
  (function (g) {
    ...
    function i(l) {
      ...
      if (
        (k = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(l))
      ) {
    ...
    g.fn.extend({
      ...
      toggleClass: function (m, l, k, o, n) {
        if (typeof l == 'boolean' || l === undefined) {
          ...
          return g.effects.animateClass.apply(this, [{ toggle: m }, l, k, o]);
        }
      },
      switchClass: function (k, m, l, o, n) {
        return g.effects.animateClass.apply(this, [{ add: m, remove: k }, l, o, n]);
      },
    });
    g.extend(g.effects, {
      version: '1.8',
      ...
      createWrapper: function (k) {
        ...
        var l = { width: k.outerWidth(true), height: k.outerHeight(true), float: k.css('float') },
          m = g('<div></div>')
    ...
    g.fn.extend({
      effect: function (n, m, p, q) {
        var l = d.apply(this, arguments),
          o = { options: l[1], duration: l[2], callback: l[3] },
          k = g.effects[n];
...
(function (a) {
  a.effects.bounce = function (b) {
    return this.queue(function () {
      ...
      var c =
        b.options.distance || (f == 'top' ? e.outerHeight({ margin: true }) / 3 : e.outerWidth({ margin: true }) / 3);
      if (k == 'show') {
...
(function (a) {
  a.effects.drop = function (b) {
    return this.queue(function () {
      ...
      var j =
        b.options.distance || (f == 'top' ? e.outerHeight({ margin: true }) / 2 : e.outerWidth({ margin: true }) / 2);
      if (i == 'show') {
    ...
    return this.queue(function () {
      var f = a(this),
        ...
        c = a('<div class="ui-effects-transfer"></div>')
          ...
          .css({ top: d.top, left: d.left, height: f.innerHeight(), width: f.innerWidth(), position: 'absolute' })
...
/**END of jquery-ui-1.8.custom.min.js**/
