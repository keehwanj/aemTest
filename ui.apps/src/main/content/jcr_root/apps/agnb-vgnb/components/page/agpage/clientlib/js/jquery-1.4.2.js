      ...
      if ((options = arguments[i]) != null) {
        ...
        for (name in options) {
          ...
          if (deep && copy && (jQuery.isPlainObject(copy) || jQuery.isArray(copy))) {
            var clone =
              src && (jQuery.isPlainObject(src) || jQuery.isArray(src)) ? src : jQuery.isArray(copy) ? [] : {};
  ...
  if ('getBoundingClientRect' in document.documentElement) {
    jQuery.fn.offset = function (options) {
      ...
      var box = elem.getBoundingClientRect(),
        ...
        top =
          box.top + (self.pageYOffset || (jQuery.support.boxModel && docElem.scrollTop) || body.scrollTop) - clientTop,
        left =
          box.left +
