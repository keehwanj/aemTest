...
<%
    ...
    try {
        ...
        sUrl = "http://www.agnb-vgnb.ca" + sUrl + selectors + ".html"; 
        //out.write("***sUrl = *** = " + sUrl); 
...
<%
    ...
    if (Utils.isNotEmpty(request.getParameter("name"))) {
    	...
    	mail.setSubject("www.agnb-vgnb.ca Feedback/ Commentaires " + new String(request.getParameter("name").getBytes("iso-8859-1"), "UTF-8"));
