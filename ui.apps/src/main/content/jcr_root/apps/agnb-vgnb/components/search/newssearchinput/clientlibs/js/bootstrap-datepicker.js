/* START of bootstrap-datepicker.js
 * !
    ...
    fill: function () {
      ...
      for (var i = -1; i < 11; i++) {
        ...
        if (this.o.beforeShowYear !== $.noop) {
          ...
          else if (typeof yrBefore === 'boolean') yrBefore = { enabled: yrBefore };
          else if (typeof yrBefore === 'string') yrBefore = { classes: yrBefore };
...
/* END of bootstrap-datepicker.js*/
