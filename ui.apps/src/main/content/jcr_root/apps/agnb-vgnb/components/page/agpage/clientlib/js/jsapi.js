...
if (!window['google']['loader']) {
  ...
  google.loader.ClientLocation = {
    latitude: 45.95,
    longitude: -66.667,
    address: { city: 'Fredericton', region: 'NB', country: 'Canada', country_code: 'CA' },
  };
  ...
  (function () {
    ...
    l(google, function (a, b, c) {
      ...
      if (
        a instanceof Array ||
        (a && 'object' == typeof a && 'function' == typeof a[B] && 'function' == typeof a.reverse)
      )
      ...
      if ((a = M[':' + f])) {
        ...
        c &&
          ...
          ((k = c.callback), k.match(/^[[\]A-Za-z0-9._]+$/) && ((k = g.eval(k)), (c.callback = k)));
    ...
    google.T = function (a, b) {
      b
        ? (0 == O[x] &&
            (P(g, 'load', Q),
            (!D('msie') && !D('safari') && !D('konqueror') && D('mozilla')) || g.opera
    ...
    google[z].R = function (a) {
      if ((a = a.specs) && a[x])
        for (var b = 0; b < a[x]; ++b) {
          ...
          'string' == typeof c
            ? (M[':' + c] = new U(c))
            : ((c = new V(c[w], c.baseSpec, c.customSpecs)), (M[':' + c[w]] = c));
        }
    };
      ...
      if (null != c)
        for (var f in c)
          a.params[f]
            ...
            : 'other_params' == f
            ? (e += '&' + c[f])
            : 'base_domain' == f && (b = 'http://' + c[f] + a.uri[A](a.uri[u]('/', 7)));
      google[this[w]] = {};
      -1 == b[u]('?') && e && (e = '?' + e[A](1));
      return b + e;
    };
    ...
    specs: [
      ...
      'orkut',
      {
        ...
        baseSpec: {
          ...
          version: { string: 'v' },
          deferred: true,
          params: { callback: { string: 'callback' }, language: { string: 'hl' }, country: { string: 'gl' } },
        },
      },
      'language',
      'earth',
  ...
  google.loader.rpl({
    ...
    ':mootools': {
      ...
      aliases: { ':1': '1.1.2', ':1.11': '1.1.1', ':1.4': '1.4.2', ':1.3': '1.3.2', ':1.2': '1.2.5', ':1.1': '1.1.2' },
    },
    ':jqueryui': {
      versions: {
