/**START of est.js for EDUCATION**/
function adCalc(form) {
  var income = form.income.value;
  var FTInfants = form.FTInfants.value;
  var PTInfants = form.PTInfants.value;
  var FTChild = form.FTChild.value;
  var PTChild = form.PTChild.value;
  ...
  //alert (FTIdays + PTIdays + FTCdays + PTCdays)
  var monthly;
  var incomplete = 'Enter your income so we can give you an estimate';
  var totalfamily = form.family.value;
  ...
  if (income > 0 && income < 22001) {
    ...
    form.yearly.value = (totalfamily * 22 * 12).toFixed(2);
    ok++;
  }
  ...
  if (income > 55000) {
    form.family.value = 'Your income is above $55k';
    ok++;
  }
}
/**END of est.js for EDUCATION**/
