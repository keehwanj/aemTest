...
(function ($) {
  ...
  $.fn.tabs = function (initial, settings) {
    ...
    $.browser.msie6 =
      $.browser.msie && (($.browser.version && $.browser.version < 7) || /MSIE 6.0/.test(navigator.userAgent)); // do not check for 6.0 alone, userAgent in Windows Vista has "Windows NT 6.0"
    ...
    return this.each(function () {
      ...
      tabs.bind('click', function (e) {
        ...
        if (
          ...
          (typeof onClick == 'function' && onClick(this, toShow[0], toHide[0]) === false)
        ) {
          this.blur();
          return false;
        }
