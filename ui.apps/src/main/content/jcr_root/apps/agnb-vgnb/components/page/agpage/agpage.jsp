    ...
    if (WCMMode.fromRequest(request) == WCMMode.EDIT) {
      Locale locale = currentPage.getLanguage(true);
        ...
        if(locale !=null) {
            ...
            String en_text="Auditor General of New Brunswick, Canada";
            String fr_text="Vérificatrice générale du Nouveau-Brunswick, Canada";
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("en")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Auditor General of New Brunswick, Canada");    
                }
            ...
            if (locale != null && locale.getLanguage().equalsIgnoreCase("fr")) {
                ...
                if(gnbPublisher_text==""){
                    currentNode.setProperty("gnbPublisher","Vérificatrice générale du Nouveau-Brunswick, Canada");    
                }
