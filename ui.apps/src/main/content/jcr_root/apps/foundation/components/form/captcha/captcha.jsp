...
<script type="text/javascript">
    ...
    async function captchaRefresh() {
		...
		var servletkey = await $.get('/content/gnb/servlets/captchaSecretServlet.captcha.json', {
			id: captchakey
		});
		...
		ctx.fillText(servletkey.captcha, 1,12,48);
		if (captchaContainer.hasChildNodes()) {
			var currentCaptcha = document.getElementById("captchaImg")
			captchaContainer.replaceChild(canv, currentCaptcha);
		} else {
    ...
    <div class="form_rightcol col-sm-8">
        ...
        <div class="row">
        	...
        	<div class="form_captcha_img col-sm-3">
				<div class="form_captcha_img" id="captchaContainer"></div>
        	</div>
