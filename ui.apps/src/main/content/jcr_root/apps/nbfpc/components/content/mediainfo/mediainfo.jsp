...
%>
  ...
  <%
    ...
    final String displayPhoto = Utils.isNotEmpty(slingRequest.getParameter("dphoto")) ? slingRequest.getParameter("dphoto") : "1";
	...
	final String itemPath = baseItemPath + "/jcr:content/renditions/cq5dam.web.1280.1280.jpeg";    
...
<script language="javaScript">
        ...
        $(document).ready(function() {        
          $(".imageSwitcher").click(function() {
            ...
            //START of new code to display title/content for multiple images
            var title = $('#'+link).val();  
            $('#md_link').text(title);                
			var text = $('#'+content).val();
            $('#md_content').text(text);              
			//END of new code to display title/content for multiple images
