...
<%}%>    
    ...
    if(url.equalsIgnoreCase("/content/nbfpc-cqfnb")){ %>
		<meta name="google-site-verification" content="qf0a-TBSul__TLWKSSfm5ZE7VWk3NGCqCrvev69x3pE" />
	<%}%>

	<cq:include script="/apps/gnb/init/init.jsp"/>
	<cq:includeClientLib categories="nbfpc.bootstrap.all"/>    


	<link rel="shortcut icon" href="/etc/designs/nbfpc-bootstrap/clientlibs/favicon.ico" type="image/x-icon" />
