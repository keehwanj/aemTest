...
<%!protected String getLocalization(String key, String defaultValue, Page currentPage, Logger log) {
        try {
            ...
            while (myPage != null) {
                ...
                if (myNode != null && myNode.hasNode("jcr:content") && myNode.getNode("jcr:content").hasNode("nbfpc_siteFooter") && myNode.getNode("jcr:content").getNode("nbfpc_siteFooter").hasProperty(key)) {
                    Property prop = myNode.getNode("jcr:content").getNode("nbfpc_siteFooter").getProperty(key);
...
<%
    ...
    try {
        ...
        //sUrl = "https://www.electionsnb.ca" + sUrl + selectors + ".html"; 
