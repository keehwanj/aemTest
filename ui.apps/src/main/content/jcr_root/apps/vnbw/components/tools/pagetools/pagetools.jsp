...
%>
<!--have to figure out the way of clientlibs-->
...
if(!hideTitle) {
%>
<div class="addthis_toolbox addthis_default_style visible-lg-block">
    ...
    <a href="//www.addthis.com/bookmark.php?v=250&amp;username=commnb">
        ...
        <!--<img alt="<%=resources.get("share")%>" title="<%=resources.get("share")%>" src="//s7.addthis.com/static/btn/v2/lg-share-<%=lang%>.gif" width="125" height="16" style="border:0"/>-->
