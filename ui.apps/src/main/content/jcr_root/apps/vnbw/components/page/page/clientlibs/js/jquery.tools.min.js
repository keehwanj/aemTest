...
(function (c) {
  ...
  c.tools.addTipEffect(
    ...
    function () {
      ...
      this.getTip()
        .css({ opacity: 0 })
        .animate({ top: "-=" + e, opacity: d.opacity }, d.slideInSpeed || 200)
        .show();
    },
    function () {
      var d = this.getConf();
...
(function (b) {
  ...
  function a(h, d) {
    ...
    q.load(function () {
      ...
      if (!m) {
        ...
        if (!m) {
          throw (
            "background-image CSS property not set for overlay element: " + j
          );
        }
      ...
      n = b('<img src="' + m + '"/>');
      n.css({ border: 0, position: "absolute", display: "none" })
        .width(s)
        .attr("overlay", true);
      b("body").append(n);
      if (k) {
  ...
  b.fn.overlay = function (e) {
    ...
    var g = {
      ...
      finish: { top: 80, left: "center", absolute: false },
      speed: "normal",
      fadeInSpeed: "fast",
      closeSpeed: "fast",
      close: null,
  ...
  function c(g, h) {
    ...
    b.extend(this, {
      ...
      load: function () {
        ...
        var l = d.height();
        if (!this.isLoaded()) {
          d.css({ opacity: 0, display: "block" }).fadeTo(
            h.loadSpeed,
            h.opacity,
            function () {
              if (d.height() != l) {
