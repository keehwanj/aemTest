...
<head>
	...
	if(url.equalsIgnoreCase("/content/vnbw-vfnb/en")){%>
		<meta name="google-site-verification" content="ZXAFAkuFdte5hj0Rut-EBtH3PYbSbnKZkXZS0QsHChw" /> 
	<%}%>
	<cq:include script="/apps/gnb/init/init.jsp"/>
    <cq:includeClientLib categories="vnbw.bootstrap.all"/>

    <link rel="shortcut icon" href="/etc/designs/vnbw-bootstrap/clientlibs/favicon.ico" type="image/x-icon" />  
