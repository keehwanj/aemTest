    ...
    prepareOffsets: function (e, g) {
      ...
      droppablesLoop: for (var d = 0; d < b.length; d++) {
        if (
          ...
          (e && !b[d].accept.call(b[d].element[0], e.currentItem || e.element))
        ) {
          continue;
        }
  ...
  a.widget("ui.sortable", a.ui.mouse, {
    ...
    serialize: function (d) {
      ...
      a(b).each(function () {
        ...
        if (e) {
          c.push(
            (d.key || e[1] + "[]") + "=" + (d.key && d.expression ? e[1] : e[2])
          );
        }
      });
      return c.join("&");
    ...
    _contactContainers: function (b) {
      ...
      if (this.containers.length === 1) {
        ...
        if (this.currentContainer != this.containers[k]) {
          ...
          var g = null;
          var c =
            this.positionAbs[this.containers[k].floating ? "left" : "top"];
          ...
          g
            ? this._rearrange(b, g, null, true)
            : this._rearrange(b, null, this.containers[k].element, true);
    ...
    _clear: function (d, e) {
      ...
      if (!a.ui.contains(this.element[0], this.currentItem[0])) {
        ...
        for (var c = this.containers.length - 1; c >= 0; c--) {
          if (
            a.ui.contains(this.containers[c].element[0], this.currentItem[0]) &&
            !e
          ) {
            f.push(
              function (g) {
  ...
  a.widget("ui.accordion", {
    ...
    _clickHandler: function (b, f) {
      ...
      d.active =
        d.collapsible && i
          ? false
          : a(".ui-accordion-header", this.element).index(g);
        ...
        if (this.type === "radio") {
          ...
          this.buttonElement
            ...
            .bind("keydown.button", function (l) {
              ...
              if (
                l.keyCode == f.ui.keyCode.SPACE ||
                l.keyCode == f.ui.keyCode.ENTER
              ) {
                f(this).addClass("ui-state-active");
              }
            })
    ...
    _resetButton: function () {
      ...
      if (h.primary || h.secondary) {
        ...
        if (!this.options.text) {
          j.addClass(
            g ? "ui-button-icons-only" : "ui-button-icon-only"
  ...
  b.extend(b.ui.dialog.overlay, {
    ...
    destroy: function (c) {
      this.oldInstances.push(
        this.instances.splice(b.inArray(c, this.instances), 1)[0]
      );
      if (this.instances.length === 0) {
    ...
    _refreshValue: function () {
      ...
      if (this.options.values && this.options.values.length) {
        ...
        this.handles.each(function (q, o) {
          var p =
            ((m.values(q) - m._valueMin()) / (m._valueMax() - m._valueMin())) *
            100;
          var n = {};
          ...
          if (m.options.range === true) {
            if (m.orientation == "horizontal") {
              q == 0 &&
                m.range
                  .stop(1, 1)
                  [d ? "animate" : "css"]({ left: p + "%" }, e.animate);
              q == 1 &&
              ...
              q == 0 &&
                m.range
                  .stop(1, 1)
                  [d ? "animate" : "css"]({ bottom: p + "%" }, e.animate);
              q == 1 &&
                m.range[d ? "animate" : "css"](
        ...
        g == "min" &&
          ...
          this.range
            .stop(1, 1)
            [d ? "animate" : "css"]({ width: f + "%" }, e.animate);
        g == "max" &&
          this.orientation == "horizontal" &&
        ...
        g == "min" &&
          ...
          this.range
            .stop(1, 1)
            [d ? "animate" : "css"]({ height: f + "%" }, e.animate);
        g == "max" &&
          this.orientation == "vertical" &&
          this.range[d ? "animate" : "css"](
            { height: 100 - f + "%" },
  ...
  (function (g) {
    ...
    g.fn.extend({
      ...
      addClass: function (l, k, n, m) {
        return k
          ? g.effects.animateClass.apply(this, [{ add: l }, k, n, m])
          : this._addClass(l);
      },
      _removeClass: g.fn.removeClass,
      removeClass: function (l, k, n, m) {
        return k
          ? g.effects.animateClass.apply(this, [{ remove: l }, k, n, m])
          : this._removeClass(l);
      },
    ...
    function d(l, k, m, n) {
      ...
      m = g.fx.off
        ...
        : typeof m == "number"
        ? m
        : g.fx.speeds[m] || g.fx.speeds._default;
      n = n || k.complete;
      return [l, k, m, n];
    }
    g.fn.extend({
    ...
    g.extend(g.easing, {
      ...
      easeInOutBounce: function (l, m, k, o, n) {
        ...
        return (
          g.easing.easeOutBounce(l, m * 2 - n, 0, o, n) * 0.5 + o * 0.5 + k
        );
      },
    });
  })(jQuery);
