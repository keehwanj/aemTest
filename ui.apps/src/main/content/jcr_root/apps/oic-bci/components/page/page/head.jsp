...
<%}%>    
    ...
    if(url.equalsIgnoreCase("/content/enb")){ %>
	...
	<cq:includeClientLib categories="oic.bootstrap.all"/>    
	<script src='http://www.google.com/jsapi' type='text/javascript' ></script>    

	<link rel="shortcut icon" href="/etc/designs/oic-bootstrap/clientlibs/favicon.ico" type="image/x-icon" />
