...
<ul>
    ...
    <%if (lang.equals("en")) {%>
    	<li class="visible-sm visible-md"><a href="/content/oic-bci/en/search.html">Search</a></li>   
    	<li class="visible-xs visible-sm visible-md"><a href="/content/oic-bci/en/media.html">Media</a></li>      

    <%}
	else{%>
    	<li class="visible-sm visible-md"><a href="/content/oic-bci/fr/recherche.html">Recherche</a></li>   
    	<li class="visible-xs visible-sm visible-md"><a href="/content/oic-bci/fr/media.html">M&eacute;dia</a></li>      
