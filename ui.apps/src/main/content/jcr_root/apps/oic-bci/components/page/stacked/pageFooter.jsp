	...
	<div id="footer">
		<div class="row">        
    		<div id="footerToolbar" class="col-sm-12 hidden-xs hidden-sm hidden-md">
        		<cq:include path="footerToolbar" resourceType="oic-bci/components/tools/footertools"/>    
    		</div>
		</div>
		...
		<div class="row">        
    		<div id="footerDisclaimer" class="col-sm-12">
        		<cq:include path="siteFooter" resourceType="oic-bci/components/tools/sitefooter"/>    
    		</div>
		</div>
