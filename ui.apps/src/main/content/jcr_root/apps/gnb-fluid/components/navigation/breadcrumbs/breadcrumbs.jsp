...
<%@page import="com.day.cq.wcm.api.WCMMode"%><%
      ...
      try{
          ...
          while (myPage != null) {
              ...
              if(myNode!=null && myNode.hasNode("jcr:content") &&  myNode.getNode("jcr:content").hasNode("header") && myNode.getNode("jcr:content").getNode("header").hasNode("breadcrumbs")) {
                  Property prop = myNode.getNode("jcr:content").getNode("header").getNode("breadcrumbs").getProperty("absParent");
