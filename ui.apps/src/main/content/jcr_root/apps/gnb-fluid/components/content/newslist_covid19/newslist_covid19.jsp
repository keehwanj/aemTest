...
<%
  ...
  String section_title = properties.get("section_title", "Latest news releases");
...
try{ 
  ...
  if (!list.isEmpty()) {
	...
	%>
    <div class="font-weight-bold" style="font-size:125%;"><%out.write(section_title);%></div>
    <%
...
///======End
        %>
     	...
     	<div><i class="fa fa-circle fa-xs mr-2" style="font-size: 8px;"></i></i><%out.write(navItem);%></div>
