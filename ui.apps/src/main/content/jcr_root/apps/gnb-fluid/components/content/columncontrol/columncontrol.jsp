...
<div class="row">
	<c:choose>
		...
		<c:when test="${coltype eq '4-8-col'}">
	  		<div class="col-sm-4 first ${color}">
                <cq:include path="icol-4-8-1" resourceType="/libs/foundation/components/iparsys" />
                <cq:include path="col-4-8-1" resourceType="/libs/foundation/components/parsys" />
            </div>
		...
		<c:when test="${coltype eq '3-9-col'}">
			<div class="col-sm-3 first ${color}">
                <cq:include path="icol-3-9-1" resourceType="/libs/foundation/components/iparsys" />
                <cq:include path="col-3-9-1" resourceType="/libs/foundation/components/parsys" />
            </div>
		...
		<c:when test="${coltype eq '2-2-2-2-2-col'}">
			<div class="col-md ${color}"><cq:include path="col-2-2-2-2-2-1" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md ${color}"><cq:include path="col-2-2-2-2-2-2" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md ${color}"><cq:include path="col-2-2-2-2-2-3" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md ${color}"><cq:include path="col-2-2-2-2-2-4" resourceType="/libs/foundation/components/parsys" /></div>
			<div class="col-md last"><cq:include path="col-2-2-2-2-2-5" resourceType="/libs/foundation/components/parsys" /></div>
		</c:when>  
