...
<%String sectionTitle		="";
  ...
  String imagePath 			= "";
  boolean description 		= properties.get("description", false);
...
/*end of new code*/
  ...
  if (Utils.isNotEmpty(featureTitleLink)) {
    if(featureTitleLink.contains("href")) {
      out.write(String.format("<h2 class=\"%s\"><span></span>%s</h2>", style, featureTitleLink));
    } else {
...
$(document).ready(function() {
  $('div.imagecontainer img').each(function(){
    ...
    if((new_class.indexOf("img-responsive") > -1) ||new_src.indexOf("/etc/designs/default/resources/0.gif") > -1){
		new_class	=new_class;
    }
    else{
