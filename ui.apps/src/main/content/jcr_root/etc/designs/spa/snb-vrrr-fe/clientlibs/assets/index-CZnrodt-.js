...
import { B as F, M as de, F as me, H as V } from './Error-46B2bSsF.js';
import { C as U, a as N } from './CheckboxGroup-BCtohx8_.js';
import { M as ue, A as he, T as $, C as pe, f as L } from './CodeAuthentication-Nw7KkDH2.js';
import { T, u as ge } from './useMetadata-YkuU4LQg.js';
import { B as G } from './BackLink-IZL3K4ex.js';
function B() {
  const { t: a } = M();
  return e.jsxs('div', {
